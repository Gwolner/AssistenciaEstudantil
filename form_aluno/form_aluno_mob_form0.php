...
<?php
include_once("form_aluno_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_aluno_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['recarga'];
}
?>
...
<?php
 include_once("form_aluno_mob_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['insert_validation']; ?>">
<?php
}
?>
...
<input type="hidden" name="id_aluno" value="<?php  echo $this->form_encode_input($this->id_aluno) ?>">
<input type="hidden" name="_sc_force_mobile" id="sc-id-mobile-control" value="" />
<?php
$_SESSION['scriptcase']['error_span_title']['form_aluno_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_aluno_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['fast_search'][2] : "";
?> 
...
<?php echo nmButtonOutput($this->arr_buttons, "balterar", "nm_atualiza ('alterar');", "nm_atualiza ('alterar');", "sc_b_upd_t", "", "Realizar Empréstimo", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "group_2_t");?>
  </div>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_mensagem_line" id="hidden_field_data_mensagem" style="<?php echo $sStyleHidden_mensagem; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mensagem_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_mensagem_label"><span id="id_label_mensagem"><?php echo $this->nm_new_label['mensagem']; ?></span></span><br><input type="hidden" name="mensagem" value="<?php echo $this->form_encode_input($mensagem); ?>"><span id="id_ajax_label_mensagem"><?php echo nl2br($mensagem); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fardamento_line" id="hidden_field_data_fardamento" style="<?php echo $sStyleHidden_fardamento; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td width="100%" class="scFormDataFontOdd css_fardamento_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fardamento_label"><span id="id_label_fardamento"><?php echo $this->nm_new_label['fardamento']; ?></span></span><br>
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_aluno_mob_empty.htm' : $this->Ini->link_form_fardamento_tradicional_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=290');
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fardamento_ed_fis_line" id="hidden_field_data_fardamento_ed_fis" style="<?php echo $sStyleHidden_fardamento_ed_fis; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td width="100%" class="scFormDataFontOdd css_fardamento_ed_fis_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fardamento_ed_fis_label"><span id="id_label_fardamento_ed_fis"><?php echo $this->nm_new_label['fardamento_ed_fis']; ?></span></span><br>
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_aluno_mob_empty.htm' : $this->Ini->link_form_fardamento_educacao_fisica_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=290');
?>
...
<?php $sStyleHidden_fardamento_ed_fis_dumb = ('' == $sStyleHidden_fardamento_ed_fis) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fardamento_ed_fis_dumb" style="<?php echo $sStyleHidden_fardamento_ed_fis_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_aluno_mob_empty.htm' : $this->Ini->link_form_emprestimo_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=520');
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_data_entrega_line" id="hidden_field_data_data_entrega" style="<?php echo $sStyleHidden_data_entrega; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_data_entrega_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_data_entrega_label"><span id="id_label_data_entrega"><?php echo $this->nm_new_label['data_entrega']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['php_cmp_required']['data_entrega']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['php_cmp_required']['data_entrega'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
?> 
    ...
    <TD class="scFormDataOdd css_livrov2_line" id="hidden_field_data_livrov2" style="<?php echo $sStyleHidden_livrov2; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_livrov2_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_livrov2_label"><span id="id_label_livrov2"><?php echo $this->nm_new_label['livrov2']; ?></span></span><br>
...
?> 
    ...
    <TD class="scFormDataOdd css_livrov3_line" id="hidden_field_data_livrov3" style="<?php echo $sStyleHidden_livrov3; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_livrov3_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_livrov3_label"><span id="id_label_livrov3"><?php echo $this->nm_new_label['livrov3']; ?></span></span><br>
...
?> 
    ...
    <TD class="scFormDataOdd css_livrovu_line" id="hidden_field_data_livrovu" style="<?php echo $sStyleHidden_livrovu; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_livrovu_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_livrovu_label"><span id="id_label_livrovu"><?php echo $this->nm_new_label['livrovu']; ?></span></span><br>
...
?> 
    ...
    <TD class="scFormDataOdd css_paradidatico_line" id="hidden_field_data_paradidatico" style="<?php echo $sStyleHidden_paradidatico; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_paradidatico_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_paradidatico_label"><span id="id_label_paradidatico"><?php echo $this->nm_new_label['paradidatico']; ?></span></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['mostra_cab'] != "N"))
  {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_aluno_mob");
 parent.scAjaxDetailHeight("form_aluno_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
