...
//
   ...
   @session_start() ;
       ...
       {
          include_once('form_aluno_mob.php');
          exit;
       }
   }
   $_SESSION['scriptcase']['form_aluno']['glo_nm_perfil']          = "conn_mysql";
...
class form_aluno_ini
{
   ...
   var $link_form_fardamento_educacao_fisica_edit;
   var $link_form_emprestimo_edit;
   var $link_control_aluno_edit;
   var $link_form_aluno_inline;
   var $nm_cont_lin;
   var $nm_limite_lin;
...
<?php
      ...
      $this->link_form_fardamento_educacao_fisica_edit = $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_fardamento_educacao_fisica') . "/" ; 
      ...
      $this->link_form_aluno_inline = $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_aluno') . "/form_aluno_inline.php";
      $this->nm_cont_lin       = 0;
...
// 
      ...
      if(function_exists('set_php_timezone'))  set_php_timezone('form_aluno'); 
   ...
   function init2()
   {
      if (isset($_SESSION['sc_session'][$this->sc_page]['form_aluno']['initialize']) && $_SESSION['sc_session'][$this->sc_page]['form_aluno']['initialize'])  
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['initialize'] = false;
      } 
      $this->conectDB();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['form_aluno']['glo_nm_conexao'], $this->root . $this->path_prod, 'SAE'); 
      } 
      else 
      { 
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['form_aluno']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['form_aluno']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['form_aluno']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['form_aluno']['SC_sep_date1'];
           }
...
//
    ...
    {
        if ('ajax_form_aluno_validate_mensagem' == $_POST['rs'])
        {
            $mensagem = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_aluno_validate_nome_aluno' == $_POST['rs'])
        {
            $nome_aluno = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_aluno_validate_curso' == $_POST['rs'])
        {
            $curso = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_aluno_validate_turno' == $_POST['rs'])
        {
            $turno = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_aluno_validate_matricula' == $_POST['rs'])
        {
            $matricula = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_aluno_validate_cpf' == $_POST['rs'])
        {
            $cpf = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_aluno_validate_celular' == $_POST['rs'])
        {
            $celular = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_aluno_validate_email' == $_POST['rs'])
        {
            $email = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_aluno_validate_fardamento' == $_POST['rs'])
        {
            $fardamento = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_aluno_validate_fardamento_ed_fis' == $_POST['rs'])
        {
            $fardamento_ed_fis = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_aluno_validate_emprestimos' == $_POST['rs'])
        {
            $emprestimos = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_aluno_validate_data_entrega' == $_POST['rs'])
        {
            $data_entrega = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_aluno_validate_data_devolucao' == $_POST['rs'])
        {
            $data_devolucao = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_aluno_validate_livros' == $_POST['rs'])
        {
            $livros = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_aluno_validate_livrov2' == $_POST['rs'])
        {
            $livrov2 = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_aluno_validate_livrov3' == $_POST['rs'])
        {
            $livrov3 = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_aluno_validate_livrovu' == $_POST['rs'])
        {
            $livrovu = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_aluno_validate_paradidatico' == $_POST['rs'])
        {
    ...
    if (isset($script_case_init) && !is_array($script_case_init) && !isset($_SESSION['sc_session'][$script_case_init]['form_aluno']['run_modal']))
    { 
        $_SESSION['sc_session'][$script_case_init]['form_aluno']['run_modal'] = isset($_GET['nmgp_url_saida']) && 'modal' == $_GET['nmgp_url_saida'];
    } 
    ...
    else
    {
        ...
        if (isset($_POST["id_aluno"])) 
        {
            ...
            nm_limpa_str_form_aluno($_SESSION['id_aluno']);
        }
        ...
        if (isset($_POST["situacao_aluno"])) 
        {
            ...
            nm_limpa_str_form_aluno($_SESSION['situacao_aluno']);
        }
    ...
    $inicial_form_aluno->contr_form_aluno->NM_ajax_info['select_html']['livros'] = " onClick=\"\" ";
    $inicial_form_aluno->contr_form_aluno->NM_ajax_info['select_html']['livrov2'] = " onClick=\"\" ";
    $inicial_form_aluno->contr_form_aluno->NM_ajax_info['select_html']['livrov3'] = " onClick=\"\" ";
    $inicial_form_aluno->contr_form_aluno->NM_ajax_info['select_html']['livrovu'] = " onClick=\"\" ";
    $inicial_form_aluno->contr_form_aluno->NM_ajax_info['select_html']['paradidatico'] = " onClick=\"\" ";
    ...
    sajax_init();
    //$sajax_debug_mode = 1;
    sajax_export("ajax_form_aluno_validate_mensagem");
    sajax_export("ajax_form_aluno_validate_nome_aluno");
    sajax_export("ajax_form_aluno_validate_curso");
    sajax_export("ajax_form_aluno_validate_turno");
    sajax_export("ajax_form_aluno_validate_matricula");
    sajax_export("ajax_form_aluno_validate_cpf");
    sajax_export("ajax_form_aluno_validate_celular");
    sajax_export("ajax_form_aluno_validate_email");
    sajax_export("ajax_form_aluno_validate_fardamento");
    sajax_export("ajax_form_aluno_validate_fardamento_ed_fis");
    sajax_export("ajax_form_aluno_validate_emprestimos");
    sajax_export("ajax_form_aluno_validate_data_entrega");
    sajax_export("ajax_form_aluno_validate_data_devolucao");
    sajax_export("ajax_form_aluno_validate_livros");
    sajax_export("ajax_form_aluno_validate_livrov2");
    sajax_export("ajax_form_aluno_validate_livrov3");
    sajax_export("ajax_form_aluno_validate_livrovu");
    sajax_export("ajax_form_aluno_validate_paradidatico");
...
//
    ...
    function ajax_form_aluno_validate_mensagem($mensagem, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_mensagem';
    ...
    function ajax_form_aluno_validate_nome_aluno($nome_aluno, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_nome_aluno';
        $inicial_form_aluno->contr_form_aluno->NM_ajax_info['param'] = array(
    ...
    function ajax_form_aluno_validate_curso($curso, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_curso';
        $inicial_form_aluno->contr_form_aluno->NM_ajax_info['param'] = array(
    ...
    function ajax_form_aluno_validate_turno($turno, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_turno';
        $inicial_form_aluno->contr_form_aluno->NM_ajax_info['param'] = array(
    ...
    function ajax_form_aluno_validate_matricula($matricula, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_matricula';
        $inicial_form_aluno->contr_form_aluno->NM_ajax_info['param'] = array(
    ...
    function ajax_form_aluno_validate_cpf($cpf, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_cpf';
        $inicial_form_aluno->contr_form_aluno->NM_ajax_info['param'] = array(
    ...
    function ajax_form_aluno_validate_celular($celular, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_celular';
        $inicial_form_aluno->contr_form_aluno->NM_ajax_info['param'] = array(
    ...
    function ajax_form_aluno_validate_email($email, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_email';
        $inicial_form_aluno->contr_form_aluno->NM_ajax_info['param'] = array(
    ...
    function ajax_form_aluno_validate_fardamento($fardamento, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_fardamento';
        $inicial_form_aluno->contr_form_aluno->NM_ajax_info['param'] = array(
    ...
    function ajax_form_aluno_validate_fardamento_ed_fis($fardamento_ed_fis, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_fardamento_ed_fis';
        $inicial_form_aluno->contr_form_aluno->NM_ajax_info['param'] = array(
    ...
    function ajax_form_aluno_validate_emprestimos($emprestimos, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_emprestimos';
        $inicial_form_aluno->contr_form_aluno->NM_ajax_info['param'] = array(
    ...
    function ajax_form_aluno_validate_data_entrega($data_entrega, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_data_entrega';
        $inicial_form_aluno->contr_form_aluno->NM_ajax_info['param'] = array(
    ...
    function ajax_form_aluno_validate_data_devolucao($data_devolucao, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_data_devolucao';
        $inicial_form_aluno->contr_form_aluno->NM_ajax_info['param'] = array(
    ...
    function ajax_form_aluno_validate_livros($livros, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_livros';
        $inicial_form_aluno->contr_form_aluno->NM_ajax_info['param'] = array(
    ...
    function ajax_form_aluno_validate_livrov2($livrov2, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_livrov2';
        $inicial_form_aluno->contr_form_aluno->NM_ajax_info['param'] = array(
    ...
    function ajax_form_aluno_validate_livrov3($livrov3, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_livrov3';
        $inicial_form_aluno->contr_form_aluno->NM_ajax_info['param'] = array(
    ...
    function ajax_form_aluno_validate_livrovu($livrovu, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_livrovu';
        $inicial_form_aluno->contr_form_aluno->NM_ajax_info['param'] = array(
    ...
    function ajax_form_aluno_validate_paradidatico($paradidatico, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
        $inicial_form_aluno->contr_form_aluno->NM_ajax_opcao         = 'validate_paradidatico';
        $inicial_form_aluno->contr_form_aluno->NM_ajax_info['param'] = array(
    ...
    function ajax_form_aluno_submit_form($mensagem, $nome_aluno, $curso, $turno, $matricula, $cpf, $celular, $email, $data_entrega, $data_devolucao, $livros, $livrov2, $livrov3, $livrovu, $paradidatico, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
    ...
    function ajax_form_aluno_navigate_form($id_aluno, $nm_form_submit, $nmgp_opcao, $nmgp_ordem, $nmgp_arg_dyn_search, $script_case_init)
    {
        global $inicial_form_aluno;
        //register_shutdown_function("form_aluno_pack_ajax_response");
        $inicial_form_aluno->contr_form_aluno->NM_ajax_flag          = true;
   ...
   function form_aluno_pack_ajax_response()
   {
      ...
      if (isset($inicial_form_aluno->contr_form_aluno->NM_ajax_info['empty_filter']))
      {
          $aResp['empty_filter'] = $inicial_form_aluno->contr_form_aluno->NM_ajax_info['empty_filter'];
      }
      if (isset($inicial_form_aluno->contr_form_aluno->NM_ajax_info['dyn_search']['NM_Dynamic_Search']))
      {
          $aResp['dyn_search']['NM_Dynamic_Search'] = $inicial_form_aluno->contr_form_aluno->NM_ajax_info['dyn_search']['NM_Dynamic_Search'];
      }
      if (isset($inicial_form_aluno->contr_form_aluno->NM_ajax_info['dyn_search']['id_dyn_search_cmd_str']))
      {
          $aResp['dyn_search']['id_dyn_search_cmd_str'] = $inicial_form_aluno->contr_form_aluno->NM_ajax_info['dyn_search']['id_dyn_search_cmd_str'];
      }
