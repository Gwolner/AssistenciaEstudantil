...
//----- 
   function ini_controle()
   {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_aluno_mob']['nm_run_menu'] = 1;
      } 
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_aluno_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_aluno_mob']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_aluno_mob']['total']))
          {
              $_SESSION['sc_session'][$script_case_init]['form_fardamento_tradicional_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][$script_case_init]['form_fardamento_tradicional_mob']['total']);
              $_SESSION['sc_session'][$script_case_init]['form_fardamento_educacao_fisica_mob']['reg_start'] = "";
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_aluno_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_aluno_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->id_aluno)) 
          {
              $_SESSION['id_aluno'] = $this->id_aluno;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_aluno_mob']['parms']))
      {
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_aluno_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_aluno_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_aluno_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_aluno_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_aluno_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_aluno_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_aluno_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_aluno_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['initialize'])
          {
              $_SESSION['scriptcase']['form_aluno_mob']['contr_erro'] = 'on';
  $this->background();
$_SESSION['scriptcase']['form_aluno_mob']['contr_erro'] = 'off';
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_aluno']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_aluno'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob'][$I_conf]  = $Conf_opt;
              }
          }
          }
          $this->Ini->init2();
      ...
      $_SESSION['sc_session'][$script_case_init]['form_aluno_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_aluno_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_aluno_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_aluno_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_aluno_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_aluno_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_aluno_mob']['label'] = "SAE - Sistema de Assistência Estudantil";
      ...
      $_SESSION['scriptcase']['error_icon']['form_aluno_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_aluno_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";
      ...
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['embutida_call'] : $this->Embutida_call;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['table_refresh'] = false;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['where_orig'] = " where id_aluno = " . $_SESSION['id_aluno'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['where_pesq'] = " where id_aluno = " . $_SESSION['id_aluno'] . "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_aluno_mob']['goto'];
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['embutida_liga_form_insert'] != '')
      {
          ...
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['embutida_liga_form_insert'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_aluno_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_aluno/form_aluno_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_aluno_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_aluno_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_aluno_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_aluno/form_aluno_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_aluno_mob_erro.class.php"); 
      }
      $this->Erro      = new form_aluno_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['opcao']))
         { 
             if ($this->id_aluno != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_aluno_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['Voltar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['botoes']['Voltar'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_fardamento_tradicional_mob') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_fardamento_tradicional_mob') . "/form_fardamento_tradicional_apl.php");
          ...
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_fardamento_educacao_fisica_mob') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_fardamento_educacao_fisica_mob') . "/form_fardamento_educacao_fisica_apl.php");
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['recarga'] = $this->nmgp_opcao;
      }
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'fardamento_ed_fis':
               return "Fardamento Educação Física";
               break;
           case 'emprestimos':
               return "Empréstimos";
               break;
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_aluno_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_aluno_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_aluno_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_aluno_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('form_aluno') . "/", $this->nm_location, "", "_self", "ret_self", 440, 630);
	...
	$this->nm_mens_alert[] = "Verifique se algum livro foi selecionado e se a data de devolução foi preenchida!"; if ($this->NM_ajax_flag) { $this->sc_ajax_alert("Verifique se algum livro foi selecionado e se a data de devolução foi preenchida!"); }
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= " ";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6))
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_aluno_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_aluno_mob']['contr_erro'] = 'off'; 
    ...
    function ValidateField_matricula(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $Campos_Crit .= "Matrícula " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 45 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
    ...
    function ValidateField_data_entrega(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif ((!$this->NM_ajax_flag || 'validate_data_entrega' != $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['php_cmp_required']['data_entrega']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['php_cmp_required']['data_entrega'] == "on")) 
           { 
    ...
    function ValidateField_data_devolucao(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif ((!$this->NM_ajax_flag || 'validate_data_devolucao' != $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['php_cmp_required']['data_devolucao']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['php_cmp_required']['data_devolucao'] == "on")) 
           { 
      ...
      if (is_array($this->livros))
      {
          ...
          { 
              ...
              { 
                       ...
                       $this->livros .= $dados_livros_1;
                       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livros']) && !in_array($dados_livros_1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livros']))
                       {
      ...
      if (is_array($this->livrov2))
      {
          ...
          { 
              ...
              { 
                       ...
                       $this->livrov2 .= $dados_livrov2_1;
                       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrov2']) && !in_array($dados_livrov2_1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrov2']))
                       {
                           $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
      ...
      if (is_array($this->livrov3))
      {
          ...
          { 
              ...
              { 
                       ...
                       $this->livrov3 .= $dados_livrov3_1;
                       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrov3']) && !in_array($dados_livrov3_1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrov3']))
                       {
                           $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
      ...
      if (is_array($this->livrovu))
      {
          ...
          { 
              ...
              { 
                       ...
                       $this->livrovu .= $dados_livrovu_1;
                       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrovu']) && !in_array($dados_livrovu_1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrovu']))
                       {
                           $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
      ...
      if (is_array($this->paradidatico))
      {
          ...
          { 
              ...
              { 
                       ...
                       $this->paradidatico .= $dados_paradidatico_1;
                       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_paradidatico']) && !in_array($dados_paradidatico_1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_paradidatico']))
                       {
                           $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_aluno']['keyVal'] = form_aluno_mob_pack_protect_string($this->nmgp_dados_form['id_aluno']);
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['total'] < 0)
              {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livros']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livros'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livros']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livros'] = array(); 
}
...
not in(select id_estoque_livro from emprestimo where id_aluno = " . $_SESSION['id_aluno'] . " && status = 'emprestado')";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_aluno_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => form_aluno_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1])));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livros'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['livros']['valList'][$i] = form_aluno_mob_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrov2']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrov2'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrov2']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrov2'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
...
not in(select id_estoque_livro from emprestimo where id_aluno = " . $_SESSION['id_aluno'] . " && status = 'emprestado')";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrov2'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['livrov2']['valList'][$i] = form_aluno_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrov3']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrov3'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrov3']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrov3'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
...
not in(select id_estoque_livro from emprestimo where id_aluno = " . $_SESSION['id_aluno'] . " && status = 'emprestado')";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrov3'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['livrov3']['valList'][$i] = form_aluno_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrovu']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrovu'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrovu']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrovu'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
...
not in(select id_estoque_livro from emprestimo where id_aluno = " . $_SESSION['id_aluno'] . " && status = 'emprestado')";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_livrovu'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['livrovu']['valList'][$i] = form_aluno_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_paradidatico']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_paradidatico'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_paradidatico']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_paradidatico'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
...
not in(select id_estoque_livro from emprestimo where id_aluno = " . $_SESSION['id_aluno'] . " && status = 'emprestado')";
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['Lookup_paradidatico'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['paradidatico']['valList'][$i] = form_aluno_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_id_aluno($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
if($this->sc_temp_situacao_aluno != "Matriculado"){
	...
	$this->mensagem  = "<p style = 'color: red; font-size: 40px;'> Aluno não matriculado! </p>";
...
$_SESSION['scriptcase']['form_aluno_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->fardamento_ed_fis = $this->fardamento_ed_fis_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['db_changed'] = true;
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['total']);
              }

              $this->sc_evento = "insert"; 
              $this->sc_insert_on = true; 
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['form_aluno_mob']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['parms'] = "id_aluno?#?$this->id_aluno?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['where_filter_form'];
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['reg_start']) ;  
              } 
          } 
          ...
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['reg_start'] < $qt_geral_reg_form_aluno_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['dados_select'];
                  ...
                  $this->fardamento_ed_fis = $this->nmgp_dados_select['fardamento_ed_fis'];  
              }
          }
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['foreign_key']))
          {
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("form_aluno_mob_form0.php");
 }

    function form_encode_input($string)
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['csrf_token'];
    }
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      if (empty($data_search)) 
      {
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['fast_search']);
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['where_filter_form'] . " and (id_aluno = " . $_SESSION['id_aluno'] . ") and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_aluno_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['total'] = $qt_geral_reg_form_aluno_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_aluno_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['sc_outra_jan'])
   {
       $nmgp_saida_form = "form_aluno_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_aluno_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['masterValue']))
{
?>
if (parent && parent.scAjaxDetailValue)
{
<?php
foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['masterValue'] as $cmp_master => $val_master)
{
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_mob']['retorno_edit'] = "";
   }
