<?php
$str_button = 'Ceropegia_grid_view';
...
$str_block_exp = 'scriptcase__NM__btn__NM__scriptcase8_ceropegia__NM__tree_mais.png';
$str_block_col = 'scriptcase__NM__btn__NM__scriptcase8_ceropegia__NM__tree_menos.png';
?>