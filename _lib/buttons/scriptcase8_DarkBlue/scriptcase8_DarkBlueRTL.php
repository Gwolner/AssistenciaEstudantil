<?php
  ...
  $this->arr_buttons['bcons_apply']['image'] = 'scriptcase__NM__nm_scriptcase8_DarkBlue_bcons_apply.gif';
  ...
  $this->arr_buttons['bcons_cancel']['image'] = 'scriptcase__NM__nm_scriptcase8_DarkBlue_bcons_cancel.gif';
  ...
  $this->arr_buttons['bmultiselect']['image'] = 'scriptcase__NM__nm_scriptcase8_DarkBlue_bmultiselect.gif';
  ...
  $this->arr_buttons['bcons_inicio_off']['image'] = 'scriptcase__NM__nm_DarkBlue_bcons_final_off.gif';
  ...
  $this->arr_buttons['bcons_final_off']['image'] = 'scriptcase__NM__nm_DarkBlue_bcons_inicio_off.gif';
  ...
  $this->arr_buttons['binicio_off']['image'] = 'scriptcase__NM__nm_DarkBlue_bcons_final_off.gif';
  ...
  $this->arr_buttons['bretorna_off']['image'] = 'scriptcase__NM__nm_DarkBlue_bcons_avanca_off.gif';
  ...
  $this->arr_buttons['bavanca_off']['image'] = 'scriptcase__NM__nm_DarkBlue_bcons_retorna_off.gif';
  ...
  $this->arr_buttons['bfinal_off']['image'] = 'scriptcase__NM__nm_DarkBlue_bcons_inicio_off.gif';
  ...
  $this->arr_buttons['bcresumo']['image'] = 'scriptcase__NM__nm_scriptcase8_DarkBlue_bcresumo.gif';
  ...
  $this->arr_buttons['bctype']['image'] = 'scriptcase__NM__nm_scriptcase8_DarkBlue_bctype.gif';
  ...
  $this->arr_buttons['bcpersonalite']['image'] = 'scriptcase__NM__nm_scriptcase8_DarkBlue_bcpersonalite.gif';
  ...
  $this->arr_buttons['bzipcode']['image'] = 'scriptcase__NM__nm_scriptcase8_DarkBlue_bzipcode.gif';
