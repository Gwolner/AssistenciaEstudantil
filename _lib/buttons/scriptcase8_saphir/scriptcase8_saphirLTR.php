<?php
  ...
  $this->arr_buttons['bcons_inicio_off']['image'] = 'scriptcase__NM__nm_scriptcase8_saphir_bcons_inicio_off.gif';
  ...
  $this->arr_buttons['bcons_retorna_off']['image'] = 'scriptcase__NM__nm_scriptcase8_saphir_bcons_retorna_off.gif';
  ...
  $this->arr_buttons['bcons_avanca_off']['image'] = 'scriptcase__NM__nm_scriptcase8_saphir_bavanca_off.gif';
  ...
  $this->arr_buttons['bcons_final_off']['image'] = 'scriptcase__NM__nm_scriptcase8_saphir_bcons_final_off.gif';
  ...
  $this->arr_buttons['binicio_off']['image'] = 'scriptcase__NM__nm_scriptcase8_saphir_binicio_off.gif';
  ...
  $this->arr_buttons['bretorna_off']['image'] = 'scriptcase__NM__nm_scriptcase8_saphir_bretorna_off.gif';
  ...
  $this->arr_buttons['bavanca_off']['image'] = 'scriptcase__NM__nm_scriptcase8_saphir_bcons_avanca_off.gif';
  ...
  $this->arr_buttons['bfinal_off']['image'] = 'scriptcase__NM__nm_scriptcase8_saphir_bfinal_off.gif';
