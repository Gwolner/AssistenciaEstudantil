...
//-- Calcula nova data em função de incremento ou decremento de dias, meses e anos
    function CalculaData($str_data, $str_formato, $str_op, $int_dia, $int_mes, $int_ano)
    {
        global $nm_config;
...
*/
        $this->nm_calc_data($str_dia_orig, $str_mes_orig, $str_ano_orig, $int_dia, $int_mes, $int_ano, trim($str_op));
        return ($str_ano_orig . '-' . $str_mes_orig . '-' . $str_dia_orig);
    }
