...
class sc_session {
    ...
    function conect($perfil, $tab_name, $dir, $dir_prod_conf="")
    {
        ...
        else if($adodb_banco == 'pdosqlite' || $adodb_banco == 'pdo_informix' || $adodb_banco == 'pdo_mysql' || $adodb_banco == 'pdo_pgsql')
        {
           $adodb_banco = 'pdo';
        }
        ...
        if ($tpbanco == "ado_mssql")
        {
            ...
            {
                die("Erro ao estabelecer uma conexão com o banco de dados = " . $db_Sess->ErrorMsg());
                exit;
            }
        }
        elseif ($tpbanco == "db2")
