 ...
 * @access  public
 */
        function nm_xml_send($v_str_servico, $v_str_metodo, $v_str_dados, $v_bol_msie = FALSE, $v_int_timeout = 10)
        {
            ...
            $res_socket   = fsockopen($str_servidor, 80, $int_err, $str_err, $v_int_timeout=10);
            if (FALSE === $res_socket || FALSE == $res_socket)
            {
                return FALSE;
            }
            if ('GET' == $v_str_metodo)
            ...
            fputs($res_socket, "Connection: keep-alive\n\n");
...
class diagnosis
{
        ...
        function makeDiagnosis()
        {
                ...
                $this->escreveTela("    </TD>\r");
                $this->escreveTela("    <TD align='left' ". $cssText .">\r");
                $this->escreveTela("      Zend: " . $obj_ambiente->GetZendVersion() . "\r");
                $this->escreveTela("    </TD>\r");
                $this->escreveTela("  </TR>\r");
