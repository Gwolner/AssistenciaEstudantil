<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_emprestimo_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_emprestimo_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_emprestimo"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
console.log("teste");
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_emprestimo_submit_form(y, z); 
} 
<?php
}
?>
