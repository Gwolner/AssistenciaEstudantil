...
class pdfreport_acompanhamento_domiciliar_xls
{
   var $Db;
   var $Erro;
   var $Ini;
...
$_SESSION['scriptcase']['pdfreport_acompanhamento_domiciliar']['contr_erro'] = 'off'; 
   ...
   function NM_export_periodo()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->periodo, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- data
   ...
   function NM_export_motivo()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->motivo, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
