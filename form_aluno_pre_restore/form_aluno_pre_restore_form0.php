...
<?php
include_once("form_aluno_pre_restore_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_aluno_pre_restore_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['recarga'];
}
?>
...
<?php
 include_once("form_aluno_pre_restore_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_aluno_pre_restore'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_aluno_pre_restore'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_livros_label" id="hidden_field_label_livros" style="<?php echo $sStyleHidden_livros; ?>"><span id="id_label_livros"><?php echo $this->nm_new_label['livros']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['php_cmp_required']['livros']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['php_cmp_required']['livros'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_livros_line" id="hidden_field_data_livros" style="<?php echo $sStyleHidden_livros; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_livros_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fardamento_line" id="hidden_field_data_fardamento" style="<?php echo $sStyleHidden_fardamento; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fardamento_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_turno_line" id="hidden_field_data_turno" style="<?php echo $sStyleHidden_turno; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_turno_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="turno" value="<?php echo $this->form_encode_input($turno); ?>"><span id="id_ajax_label_turno"><?php echo nl2br($turno); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_celular_line" id="hidden_field_data_celular" style="<?php echo $sStyleHidden_celular; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_celular_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="celular" value="<?php echo $this->form_encode_input($celular); ?>"><span id="id_ajax_label_celular"><?php echo nl2br($celular); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_email_line" id="hidden_field_data_email" style="<?php echo $sStyleHidden_email; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_email_line" style="vertical-align: top;padding: 0px"><input type="hidden" name="email" value="<?php echo $this->form_encode_input($email); ?>"><span id="id_ajax_label_email"><?php echo nl2br($email); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_data_entrega_label" id="hidden_field_label_data_entrega" style="<?php echo $sStyleHidden_data_entrega; ?>"><span id="id_label_data_entrega"><?php echo $this->nm_new_label['data_entrega']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['php_cmp_required']['data_entrega']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['php_cmp_required']['data_entrega'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_data_devolucao_label" id="hidden_field_label_data_devolucao" style="<?php echo $sStyleHidden_data_devolucao; ?>"><span id="id_label_data_devolucao"><?php echo $this->nm_new_label['data_devolucao']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['php_cmp_required']['data_devolucao']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['php_cmp_required']['data_devolucao'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_emprestimos_line" id="hidden_field_data_emprestimos" style="<?php echo $sStyleHidden_emprestimos; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emprestimos_line" style="vertical-align: top;padding: 0px">
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['run_iframe'] != "R")
{
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "balterar", "nm_atualiza ('alterar');", "nm_atualiza ('alterar');", "sc_b_upd_b", "", "Realizar Empr�stimo", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_aluno_pre_restore");
 parent.scAjaxDetailHeight("form_aluno_pre_restore", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
