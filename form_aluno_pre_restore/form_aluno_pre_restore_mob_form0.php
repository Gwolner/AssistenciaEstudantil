...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("Situa��o do aluno"); } else { echo strip_tags("Situa��o do aluno"); } ?></TITLE>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_aluno_pre_restore/form_aluno_pre_restore_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_aluno_pre_restore_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_aluno_pre_restore_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['recarga'];
}
?>
...
<?php
 include_once("form_aluno_pre_restore_mob_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_aluno_pre_restore_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_aluno_pre_restore_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "Situa��o do aluno"; } else { echo "Situa��o do aluno"; } ?></span></td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['fast_search'][2] : "";
?> 
...
<?php echo nmButtonOutput($this->arr_buttons, "balterar", "nm_atualiza ('alterar');", "nm_atualiza ('alterar');", "sc_b_upd_t", "", "Realizar Empr�stimo", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "group_2_t");?>
  </div>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?> 
    ...
    <TD class="scFormDataOdd css_livros_line" id="hidden_field_data_livros" style="<?php echo $sStyleHidden_livros; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_livros_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_livros_label"><span id="id_label_livros"><?php echo $this->nm_new_label['livros']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['php_cmp_required']['livros']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['php_cmp_required']['livros'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fardamento_line" id="hidden_field_data_fardamento" style="<?php echo $sStyleHidden_fardamento; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fardamento_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fardamento_label"><span id="id_label_fardamento"><?php echo $this->nm_new_label['fardamento']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["fardamento"]) &&  $this->nmgp_cmp_readonly["fardamento"] == "on") { 

 ?>
<input type="hidden" name="fardamento" value="<?php echo $this->form_encode_input($fardamento) . "\">" . $fardamento . ""; ?>
<?php } else { ?>
<span id="id_read_on_fardamento" class="sc-ui-readonly-fardamento css_fardamento_line" style="<?php echo $sStyleReadLab_fardamento; ?>"><?php echo $this->form_encode_input($this->fardamento); ?></span><span id="id_read_off_fardamento" style="white-space: nowrap;<?php echo $sStyleReadInp_fardamento; ?>">
 <input class="sc-js-input scFormObjectOdd css_fardamento_obj" style="" id="id_sc_field_fardamento" type=text name="fardamento" value="<?php echo $this->form_encode_input($fardamento) ?>"
 size=10 maxlength=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("abcdefghijklmnopqrstuvwxyz0123456789áéíóúàèìòùãõâêîôûäëïöüñýÿç .,") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<?php $sStyleHidden_fardamento_dumb = ('' == $sStyleHidden_fardamento) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_fardamento_dumb" style="<?php echo $sStyleHidden_fardamento_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_turno_line" id="hidden_field_data_turno" style="<?php echo $sStyleHidden_turno; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_turno_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_turno_label"><span id="id_label_turno"><?php echo $this->nm_new_label['turno']; ?></span></span><br><input type="hidden" name="turno" value="<?php echo $this->form_encode_input($turno); ?>"><span id="id_ajax_label_turno"><?php echo nl2br($turno); ?></span>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['matricula'] = "Matr�cula:";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_celular_line" id="hidden_field_data_celular" style="<?php echo $sStyleHidden_celular; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_celular_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_celular_label"><span id="id_label_celular"><?php echo $this->nm_new_label['celular']; ?></span></span><br><input type="hidden" name="celular" value="<?php echo $this->form_encode_input($celular); ?>"><span id="id_ajax_label_celular"><?php echo nl2br($celular); ?></span>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['data_entrega'] = "Data de empr�stimo:";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_data_entrega_line" id="hidden_field_data_data_entrega" style="<?php echo $sStyleHidden_data_entrega; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_data_entrega_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_data_entrega_label"><span id="id_label_data_entrega"><?php echo $this->nm_new_label['data_entrega']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['php_cmp_required']['data_entrega']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['php_cmp_required']['data_entrega'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['data_devolucao'] = "Data de devolu��o:";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_data_devolucao_line" id="hidden_field_data_data_devolucao" style="<?php echo $sStyleHidden_data_devolucao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_data_devolucao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_data_devolucao_label"><span id="id_label_data_devolucao"><?php echo $this->nm_new_label['data_devolucao']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['php_cmp_required']['data_devolucao']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['php_cmp_required']['data_devolucao'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['emprestimos'] = "Empr�stimos:";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_emprestimos_line" id="hidden_field_data_emprestimos" style="<?php echo $sStyleHidden_emprestimos; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_emprestimos_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_emprestimos_label"><span id="id_label_emprestimos"><?php echo $this->nm_new_label['emprestimos']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["emprestimos"]) &&  $this->nmgp_cmp_readonly["emprestimos"] == "on") { 

 ?>
<input type="hidden" name="emprestimos" value="<?php echo $this->form_encode_input($emprestimos) . "\">" . $emprestimos . ""; ?>
<?php } else { ?>
<span id="id_read_on_emprestimos" class="sc-ui-readonly-emprestimos css_emprestimos_line" style="<?php echo $sStyleReadLab_emprestimos; ?>"><?php echo $this->form_encode_input($this->emprestimos); ?></span><span id="id_read_off_emprestimos" style="white-space: nowrap;<?php echo $sStyleReadInp_emprestimos; ?>">
 <input class="sc-js-input scFormObjectOdd css_emprestimos_obj" style="" id="id_sc_field_emprestimos" type=text name="emprestimos" value="<?php echo $this->form_encode_input($emprestimos) ?>"
 size=10 maxlength=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("abcdefghijklmnopqrstuvwxyz0123456789áéíóúàèìòùãõâêîôûäëïöüñýÿç .,") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['total'] + 1)?>);</script><?php }} ?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno_pre_restore_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_aluno_pre_restore_mob");
 parent.scAjaxDetailHeight("form_aluno_pre_restore_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
