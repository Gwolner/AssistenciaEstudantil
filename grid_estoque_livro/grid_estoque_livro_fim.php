...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SAE_____grid_estoque_livro"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SAE_____grid_estoque_livro"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_estoque_livro']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_estoque_livro']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_estoque_livro']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_estoque_livro']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_estoque_livro']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_estoque_livro</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_estoque_livro']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_estoque_livro']['embutida_filho'] as $ind => $sc_init)
          {
