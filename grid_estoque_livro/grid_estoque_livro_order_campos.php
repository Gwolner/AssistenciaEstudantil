<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_estoque_livro_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_estoque_livro_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['id_estoque_livro'] = "on";
   $tab_def_campos['id_estoque_livro'] = "id_estoque_livro";
   $tab_converte["id_estoque_livro"]   = "id_estoque_livro";
   $tab_labels["id_estoque_livro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['labels']["id_estoque_livro"])) ? $_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['labels']["id_estoque_livro"] : "Id Estoque Livro";
   $tab_ger_campos['materia'] = "on";
   $tab_def_campos['materia'] = "materia";
   $tab_converte["materia"]   = "materia";
   $tab_labels["materia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['labels']["materia"])) ? $_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['labels']["materia"] : "Materia";
   $tab_ger_campos['titulo'] = "on";
   $tab_def_campos['titulo'] = "titulo";
   $tab_converte["titulo"]   = "titulo";
   $tab_labels["titulo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['labels']["titulo"])) ? $_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['labels']["titulo"] : "Titulo";
   $tab_ger_campos['autor'] = "on";
   $tab_def_campos['autor'] = "autor";
   $tab_converte["autor"]   = "autor";
   $tab_labels["autor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['labels']["autor"])) ? $_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['labels']["autor"] : "Autor";
   $tab_ger_campos['isbn'] = "on";
   $tab_def_campos['isbn'] = "isbn";
   $tab_converte["isbn"]   = "isbn";
   $tab_labels["isbn"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['labels']["isbn"])) ? $_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['labels']["isbn"] : "Isbn";
   $tab_ger_campos['quantidade'] = "on";
   $tab_def_campos['quantidade'] = "quantidade";
   $tab_converte["quantidade"]   = "quantidade";
   $tab_labels["quantidade"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['labels']["quantidade"])) ? $_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['labels']["quantidade"] : "Quantidade";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - estoque_livro</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_estoque_livro_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_estoque_livro']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
