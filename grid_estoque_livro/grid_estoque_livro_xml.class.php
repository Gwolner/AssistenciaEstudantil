...
class grid_estoque_livro_xml
{
   ...
   //---- 
   function grid_estoque_livro_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_estoque_livro.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_estoque_livro";
   ...
   function NM_export_id_estoque_livro()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->id_estoque_livro))
         {
             $this->id_estoque_livro = sc_convert_encoding($this->id_estoque_livro, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " id_estoque_livro =\"" . $this->trata_dados($this->id_estoque_livro) . "\"";
   }
   //----- materia
   function NM_export_materia()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->materia))
         {
             $this->materia = sc_convert_encoding($this->materia, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " materia =\"" . $this->trata_dados($this->materia) . "\"";
   }
   //----- titulo
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->autor))
         {
             $this->autor = sc_convert_encoding($this->autor, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " autor =\"" . $this->trata_dados($this->autor) . "\"";
   }
   //----- isbn
   function NM_export_isbn()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->isbn))
         {
             $this->isbn = sc_convert_encoding($this->isbn, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " isbn =\"" . $this->trata_dados($this->isbn) . "\"";
   }
   //----- quantidade
   function NM_export_quantidade()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->quantidade))
         {
             $this->quantidade = sc_convert_encoding($this->quantidade, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " quantidade =\"" . $this->trata_dados($this->quantidade) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - estoque_livro :: XML</TITLE>
