...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_estoque_livro";$Nm_numeric[] = "id_volume";$Nm_numeric[] = "id_estoque_livro";$Nm_numeric[] = "id_volume";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_id_estoque_livro"  <?php echo $str_hide_id_estoque_livro?>><?php
      $id_estoque_livro_look = substr($this->Db->qstr($id_estoque_livro), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id_estoque_livro" name="id_estoque_livro_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_id_estoque_livro"  <?php echo $str_display_id_estoque_livro; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_estoque_livro_input_2" name="id_estoque_livro_input_2" value="<?php echo NM_encode_input($id_estoque_livro_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_materia"  <?php echo $str_hide_materia?>><?php
      $materia_look = substr($this->Db->qstr($materia), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_titulo"  <?php echo $str_hide_titulo?>><?php
      $titulo_look = substr($this->Db->qstr($titulo), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_autor"  <?php echo $str_hide_autor?>><?php
      $autor_look = substr($this->Db->qstr($autor), 1, -1); 
      $nmgp_def_dados = array(); 
