...
class grid_estoque_livro_pesq
{
    ...
    * @access  public
    */
   function grid_estoque_livro_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_estoque_livro_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_estoque_livro_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_estoque_livro_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_estoque_livro')
      {
          $id_estoque_livro = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_estoque_livro($id_estoque_livro);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_materia')
      {
          $materia = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_materia($materia);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_titulo')
      {
          $titulo = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_titulo($titulo);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_autor')
      {
          $autor = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_autor($autor);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_id_estoque_livro($id_estoque_livro)
   {
      $id_estoque_livro = substr($this->Db->qstr($id_estoque_livro), 1, -1);
            $id_estoque_livro_look = substr($this->Db->qstr($id_estoque_livro), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_estoque_livro from " . $this->Ini->nm_tabela . " where   CAST (id_estoque_livro AS TEXT)  like '%" . $id_estoque_livro . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct id_estoque_livro from " . $this->Ini->nm_tabela . " where  id_estoque_livro like '%" . $id_estoque_livro . "%'"; 
      }
   ...
   function lookup_ajax_materia($materia)
   {
      $materia = substr($this->Db->qstr($materia), 1, -1);
            $materia_look = substr($this->Db->qstr($materia), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct materia from " . $this->Ini->nm_tabela . " where  materia like '%" . $materia . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_titulo($titulo)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct titulo from " . $this->Ini->nm_tabela . " where  titulo like '%" . $titulo . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_autor($autor)
   {
      $autor = substr($this->Db->qstr($autor), 1, -1);
            $autor_look = substr($this->Db->qstr($autor), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct autor from " . $this->Ini->nm_tabela . " where  autor like '%" . $autor . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - estoque_livro</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_estoque_livro/grid_estoque_livro_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_estoque_livro_ajax_search.js"></script>
 <script type="text/javascript" src="grid_estoque_livro_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_id_estoque_livro_cond#NMF#' + search_get_sel_txt('SC_id_estoque_livro_cond') + '@NMF@';
  str_out += 'SC_id_estoque_livro#NMF#' + search_get_text('SC_id_estoque_livro') + '@NMF@';
  str_out += 'id_ac_id_estoque_livro#NMF#' + search_get_text('id_ac_id_estoque_livro') + '@NMF@';
  str_out += 'SC_id_estoque_livro_input_2#NMF#' + search_get_text('SC_id_estoque_livro_input_2') + '@NMF@';
  str_out += 'SC_materia_cond#NMF#' + search_get_sel_txt('SC_materia_cond') + '@NMF@';
  str_out += 'SC_materia#NMF#' + search_get_text('SC_materia') + '@NMF@';
  str_out += 'id_ac_materia#NMF#' + search_get_text('id_ac_materia') + '@NMF@';
  str_out += 'SC_titulo_cond#NMF#' + search_get_sel_txt('SC_titulo_cond') + '@NMF@';
  str_out += 'SC_titulo#NMF#' + search_get_text('SC_titulo') + '@NMF@';
  str_out += 'id_ac_titulo#NMF#' + search_get_text('id_ac_titulo') + '@NMF@';
  str_out += 'SC_autor_cond#NMF#' + search_get_sel_txt('SC_autor_cond') + '@NMF@';
  str_out += 'SC_autor#NMF#' + search_get_text('SC_autor') + '@NMF@';
  str_out += 'id_ac_autor#NMF#' + search_get_text('id_ac_autor') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_id_estoque_livro").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_id_estoque_livro",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_id_estoque_livro").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_id_estoque_livro").val( $(this).val() );
       }
     }
   });
   $("#id_ac_materia").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_materia",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_materia").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_materia").val( $(this).val() );
       }
     }
   });
   $("#id_ac_titulo").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_titulo",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_titulo").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_titulo").val( $(this).val() );
       }
     }
   });
   $("#id_ac_autor").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_autor",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_autor").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_autor").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - estoque_livro</span></td>
...
<?php
   ...
   {
      global 
             $id_estoque_livro_cond, $id_estoque_livro, $id_estoque_livro_input_2, $id_estoque_livro_autocomp,
             $materia_cond, $materia, $materia_autocomp,
             $titulo_cond, $titulo, $titulo_autocomp,
             $autor_cond, $autor, $autor_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_estoque_livro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']['id_estoque_livro']; 
          $id_estoque_livro_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']['id_estoque_livro_input_2']; 
          $id_estoque_livro_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']['id_estoque_livro_cond']; 
          $materia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']['materia']; 
          $materia_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']['materia_cond']; 
          $titulo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']['titulo']; 
          $titulo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']['titulo_cond']; 
          $autor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']['autor']; 
          $autor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']['autor_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']['NM_operador']; 
      } 
      if (!isset($id_estoque_livro_cond) || empty($id_estoque_livro_cond))
      {
         $id_estoque_livro_cond = "gt";
      }
      if (!isset($materia_cond) || empty($materia_cond))
      {
         $materia_cond = "qp";
      }
      if (!isset($titulo_cond) || empty($titulo_cond))
      {
         $titulo_cond = "qp";
      }
      if (!isset($autor_cond) || empty($autor_cond))
      {
         $autor_cond = "qp";
      }
      ...
      $str_hide_id_estoque_livro = (in_array($id_estoque_livro_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_materia = (in_array($materia_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_titulo = (in_array($titulo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_autor = (in_array($autor_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_id_estoque_livro = ('bw' == $id_estoque_livro_cond) ? $display_aberto : $display_fechado;

      if (!isset($id_estoque_livro) || $id_estoque_livro == "")
      {
          $id_estoque_livro = "";
      }
      if (isset($id_estoque_livro) && !empty($id_estoque_livro))
      {
         $tmp_pos = strpos($id_estoque_livro, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_estoque_livro = substr($id_estoque_livro, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($materia, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $materia = substr($materia, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($titulo, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $titulo = substr($titulo, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($autor, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $autor = substr($autor, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_estoque_livro_help.txt"))
   {
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_estoque_livro'])) ? $this->New_label['id_estoque_livro'] : "Id Estoque Livro"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_estoque_livro_cond" name="id_estoque_livro_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_estoque_livro'), this, 'id_estoque_livro')">
       <OPTION value="gt" <?php if ("gt" == $id_estoque_livro_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_estoque_livro_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_estoque_livro_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $id_estoque_livro_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_estoque_livro" <?php echo $str_hide_id_estoque_livro?> valign="top">
 ...
 $nmgp_tab_label .= "id_estoque_livro?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $id_estoque_livro_look = substr($this->Db->qstr($id_estoque_livro), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($id_estoque_livro))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_estoque_livro from " . $this->Ini->nm_tabela . " where id_estoque_livro = $id_estoque_livro_look"; 
      }
      else
      {
          $nm_comando = "select distinct id_estoque_livro from " . $this->Ini->nm_tabela . " where id_estoque_livro = $id_estoque_livro_look"; 
      ...
      if (isset($nmgp_def_dados[0][$id_estoque_livro]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_estoque_livro];
      }
      else
      {
          $sAutocompValue = $id_estoque_livro;
      }
?>
<INPUT  type="text" id="SC_id_estoque_livro" name="id_estoque_livro" value="<?php echo NM_encode_input($id_estoque_livro) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id_estoque_livro" name="id_estoque_livro_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id_estoque_livro"  <?php echo $str_display_id_estoque_livro; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_estoque_livro_input_2" name="id_estoque_livro_input_2" value="<?php echo NM_encode_input($id_estoque_livro_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['materia'])) ? $this->New_label['materia'] : "Materia"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_materia_cond" name="materia_cond" onChange="nm_campos_between(document.getElementById('id_vis_materia'), this, 'materia')">
       <OPTION value="qp" <?php if ("qp" == $materia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $materia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $materia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $materia_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_materia" <?php echo $str_hide_materia?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['materia'])) ? $this->New_label['materia'] : "Materia";
 $nmgp_tab_label .= "materia?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $materia_look = substr($this->Db->qstr($materia), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct materia from " . $this->Ini->nm_tabela . " where materia = '$materia_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$materia]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$materia];
      }
      else
      {
          $sAutocompValue = $materia;
      }
?>
<INPUT  type="text" id="SC_materia" name="materia" value="<?php echo NM_encode_input($materia) ?>" size=45 alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_materia" name="materia_autocomp" size="45" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 45, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['titulo'])) ? $this->New_label['titulo'] : "Titulo"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_titulo_cond" name="titulo_cond" onChange="nm_campos_between(document.getElementById('id_vis_titulo'), this, 'titulo')">
       <OPTION value="qp" <?php if ("qp" == $titulo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $titulo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $titulo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $titulo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_titulo" <?php echo $str_hide_titulo?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['titulo'])) ? $this->New_label['titulo'] : "Titulo";
 $nmgp_tab_label .= "titulo?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $titulo_look = substr($this->Db->qstr($titulo), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct titulo from " . $this->Ini->nm_tabela . " where titulo = '$titulo_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      {
          $sAutocompValue = $titulo;
      }
?>
<INPUT  type="text" id="SC_titulo" name="titulo" value="<?php echo NM_encode_input($titulo) ?>" size=50 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_titulo" name="titulo_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['autor'])) ? $this->New_label['autor'] : "Autor"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_autor_cond" name="autor_cond" onChange="nm_campos_between(document.getElementById('id_vis_autor'), this, 'autor')">
       <OPTION value="qp" <?php if ("qp" == $autor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $autor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $autor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $autor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_autor" <?php echo $str_hide_autor?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['autor'])) ? $this->New_label['autor'] : "Autor";
 $nmgp_tab_label .= "autor?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $autor_look = substr($this->Db->qstr($autor), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct autor from " . $this->Ini->nm_tabela . " where autor = '$autor_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$autor]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$autor];
      }
      else
      {
          $sAutocompValue = $autor;
      }
?>
<INPUT  type="text" id="SC_autor" name="autor" value="<?php echo NM_encode_input($autor) ?>" size=50 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_autor" name="autor_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_estoque_livro']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_estoque_livro']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_id_estoque_livro'), document.F1.id_estoque_livro_cond, 'id_estoque_livro');
   document.F1.id_estoque_livro.value = "";
   document.F1.id_estoque_livro_autocomp.value = "";
   document.F1.id_estoque_livro_input_2.value = "";
   nm_campos_between(document.getElementById('id_vis_materia'), document.F1.materia_cond, 'materia');
   document.F1.materia.value = "";
   document.F1.materia_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_titulo'), document.F1.titulo_cond, 'titulo');
   document.F1.titulo.value = "";
   document.F1.titulo_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_autor'), document.F1.autor_cond, 'autor');
   document.F1.autor.value = "";
   document.F1.autor_autocomp.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "SAE/grid_estoque_livro";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_id_estoque_livro_cond'] = 'cond';
      $tp_fields['SC_id_estoque_livro'] = 'text_aut';
      $tp_fields['id_ac_id_estoque_livro'] = 'text_aut';
      $tp_fields['SC_id_estoque_livro_input_2'] = 'text';
      $tp_fields['SC_materia_cond'] = 'cond';
      $tp_fields['SC_materia'] = 'text_aut';
      $tp_fields['id_ac_materia'] = 'text_aut';
      $tp_fields['SC_titulo_cond'] = 'cond';
      $tp_fields['SC_titulo'] = 'text_aut';
      $tp_fields['id_ac_titulo'] = 'text_aut';
      $tp_fields['SC_autor_cond'] = 'cond';
      $tp_fields['SC_autor'] = 'text_aut';
      $tp_fields['id_ac_autor'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $id_estoque_livro_cond, $id_estoque_livro, $id_estoque_livro_input_2, $id_estoque_livro_autocomp,
             $materia_cond, $materia, $materia_autocomp,
             $titulo_cond, $titulo, $titulo_autocomp,
             $autor_cond, $autor, $autor_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($id_estoque_livro_autocomp) && empty($id_estoque_livro))
      {
          $id_estoque_livro = $id_estoque_livro_autocomp;
      }
      if (!empty($materia_autocomp) && empty($materia))
      {
          $materia = $materia_autocomp;
      }
      if (!empty($titulo_autocomp) && empty($titulo))
      {
          $titulo = $titulo_autocomp;
      }
      if (!empty($autor_autocomp) && empty($autor))
      {
          $autor = $autor_autocomp;
      }
      $id_estoque_livro_cond_salva = $id_estoque_livro_cond; 
      if (!isset($id_estoque_livro_input_2) || $id_estoque_livro_input_2 == "")
      {
          $id_estoque_livro_input_2 = $id_estoque_livro;
      }
      $materia_cond_salva = $materia_cond; 
      if (!isset($materia_input_2) || $materia_input_2 == "")
      {
          $materia_input_2 = $materia;
      }
      $titulo_cond_salva = $titulo_cond; 
      if (!isset($titulo_input_2) || $titulo_input_2 == "")
      {
          $titulo_input_2 = $titulo;
      }
      $autor_cond_salva = $autor_cond; 
      if (!isset($autor_input_2) || $autor_input_2 == "")
      {
          $autor_input_2 = $autor;
      }
      if ($id_estoque_livro_cond != "in")
      {
          nm_limpa_numero($id_estoque_livro, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $id_estoque_livro);
          ...
          $id_estoque_livro = implode(",", $Nm_sc_valores);
      }
      if ($id_estoque_livro_cond != "in")
      {
          nm_limpa_numero($id_estoque_livro_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']['id_estoque_livro'] = $id_estoque_livro; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']['id_estoque_livro_input_2'] = $id_estoque_livro_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']['id_estoque_livro_cond'] = $id_estoque_livro_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']['materia'] = $materia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']['materia_cond'] = $materia_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']['titulo'] = $titulo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']['titulo_cond'] = $titulo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']['autor'] = $autor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']['autor_cond'] = $autor_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($id_estoque_livro_cond != "in" && $id_estoque_livro_cond != "bw" && !empty($id_estoque_livro) && !is_numeric($id_estoque_livro))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Estoque Livro";
      }
      if ($id_estoque_livro_cond == "bw" && ((!empty($id_estoque_livro) && !is_numeric($id_estoque_livro)) || (!empty($id_estoque_livro_input_2) && !is_numeric($id_estoque_livro_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Estoque Livro";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_estoque_livro'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['id_estoque_livro'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['id_estoque_livro'] = $id_estoque_livro;
      }
      $Conteudo = $id_estoque_livro_input_2;
      if (strtoupper($id_estoque_livro_cond) != "II" && strtoupper($id_estoque_livro_cond) != "QP" && strtoupper($id_estoque_livro_cond) != "NP" && strtoupper($id_estoque_livro_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_estoque_livro_input_2'] = $Conteudo;
      $materia_look = substr($this->Db->qstr($materia), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct materia from " . $this->Ini->nm_tabela . " where materia = '$materia_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['materia'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['materia'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['materia'] = $materia;
      }
      $titulo_look = substr($this->Db->qstr($titulo), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct titulo from " . $this->Ini->nm_tabela . " where titulo = '$titulo_look'"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['titulo'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['titulo'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['titulo'] = $titulo;
      }
      $autor_look = substr($this->Db->qstr($autor), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct autor from " . $this->Ini->nm_tabela . " where autor = '$autor_look'"; 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['autor'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['autor'] = $autor;
      }

      //----- $id_estoque_livro
      $this->Date_part = false;
      if (isset($id_estoque_livro) || $id_estoque_livro_cond == "nu" || $id_estoque_livro_cond == "nn" || $id_estoque_livro_cond == "ep" || $id_estoque_livro_cond == "ne")
      {
         $this->monta_condicao("id_estoque_livro", $id_estoque_livro_cond, $id_estoque_livro, $id_estoque_livro_input_2, "id_estoque_livro");
      }

      //----- $materia
      $this->Date_part = false;
      if (isset($materia) || $materia_cond == "nu" || $materia_cond == "nn" || $materia_cond == "ep" || $materia_cond == "ne")
      {
         $this->monta_condicao("materia", $materia_cond, $materia, "", "materia");
      }

      //----- $titulo
      $this->Date_part = false;
      if (isset($titulo) || $titulo_cond == "nu" || $titulo_cond == "nn" || $titulo_cond == "ep" || $titulo_cond == "ne")
      {
         $this->monta_condicao("titulo", $titulo_cond, $titulo, "", "titulo");
      }

      //----- $autor
      $this->Date_part = false;
      if (isset($autor) || $autor_cond == "nu" || $autor_cond == "nn" || $autor_cond == "ep" || $autor_cond == "ne")
      {
         $this->monta_condicao("autor", $autor_cond, $autor, "", "autor");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estoque_livro']['where_pesq_ant'] = $this->comando . $this->comando_fim;
