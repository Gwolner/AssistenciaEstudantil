...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SAE_____grid_relatorio_emprestimo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SAE_____grid_relatorio_emprestimo"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_relatorio_emprestimo']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_relatorio_emprestimo']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_relatorio_emprestimo']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_relatorio_emprestimo']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_relatorio_emprestimo']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_relatorio_emprestimo</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_relatorio_emprestimo']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_relatorio_emprestimo']['embutida_filho'] as $ind => $sc_init)
          {
