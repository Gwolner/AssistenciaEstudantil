...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_e_data_entrega"  <?php echo $str_hide_e_data_entrega?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <BR>
        <SPAN id="id_vis_e_data_entrega"  <?php echo $str_display_e_data_entrega; ?> class="scFilterFieldFontOdd">
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_e_data_devolucao"  <?php echo $str_hide_e_data_devolucao?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
  $Str_date = str_replace("a", "y", strtolower($_SESSION['scriptcase']['reg_conf']['date_format']));
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <BR>
        <SPAN id="id_vis_e_data_devolucao"  <?php echo $str_display_e_data_devolucao; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?> 
         <BR>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_e_status"  <?php echo $str_hide_e_status?>><?php
      $e_status_look = substr($this->Db->qstr($e_status), 1, -1); 
      $nmgp_def_dados = array(); 
