<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_relatorio_emprestimo_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_relatorio_emprestimo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['e_data_entrega'] = "e_data_entrega";
       $tab_converte["e_data_entrega"]   = "e_data_entrega";
   }
   else
   {
       $tab_def_campos['e_data_entrega'] = "e.data_entrega";
       $tab_converte["e.data_entrega"]   = "e_data_entrega";
   }
   $tab_labels["e_data_entrega"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_relatorio_emprestimo']['labels']["e_data_entrega"])) ? $_SESSION['sc_session'][$sc_init]['grid_relatorio_emprestimo']['labels']["e_data_entrega"] : "Data Entrega";
   $tab_ger_campos['e_data_devolucao'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['e_data_devolucao'] = "e_data_devolucao";
       $tab_converte["e_data_devolucao"]   = "e_data_devolucao";
   }
   else
   {
       $tab_def_campos['e_data_devolucao'] = "e.data_devolucao";
       $tab_converte["e.data_devolucao"]   = "e_data_devolucao";
   }
   $tab_labels["e_data_devolucao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_relatorio_emprestimo']['labels']["e_data_devolucao"])) ? $_SESSION['sc_session'][$sc_init]['grid_relatorio_emprestimo']['labels']["e_data_devolucao"] : "Data Devolucao";
   $tab_ger_campos['e_status'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['e_status'] = "e_status";
       $tab_converte["e_status"]   = "e_status";
   }
   else
   {
       $tab_def_campos['e_status'] = "e.status";
       $tab_converte["e.status"]   = "e_status";
   }
   $tab_labels["e_status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_relatorio_emprestimo']['labels']["e_status"])) ? $_SESSION['sc_session'][$sc_init]['grid_relatorio_emprestimo']['labels']["e_status"] : "Status";
   ...
   {
       $tab_def_campos['sc_field_1'] = "CASE
   ...
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_relatorio_emprestimo']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_relatorio_emprestimo']['labels']["sc_field_1"] : "Matéria/Título";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_relatorio_emprestimo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_relatorio_emprestimo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_relatorio_emprestimo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_relatorio_emprestimo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_relatorio_emprestimo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_relatorio_emprestimo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_relatorio_emprestimo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_relatorio_emprestimo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_relatorio_emprestimo']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_relatorio_emprestimo_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_relatorio_emprestimo']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_relatorio_emprestimo']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
