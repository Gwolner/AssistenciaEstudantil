...
class grid_relatorio_emprestimo_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_relatorio_emprestimo_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_relatorio_emprestimo_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_relatorio_emprestimo_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_relatorio_emprestimo_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_e_status')
      {
          $e_status = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_e_status($e_status);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_e_status($e_status)
   {
      $e_status = substr($this->Db->qstr($e_status), 1, -1);
            $e_status_look = substr($this->Db->qstr($e_status), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct e.status from " . $this->Ini->nm_tabela . " where e.status = 'emprestado' && e.id_aluno = a.id_aluno && e.id_estoque_livro = es.id_estoque_livro and  e.status like '%" . $e_status . "%'"; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "e_data_entrega";$Nm_datas[] = "e_data_devolucao";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - </TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_relatorio_emprestimo/grid_relatorio_emprestimo_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_relatorio_emprestimo_ajax_search.js"></script>
 <script type="text/javascript" src="grid_relatorio_emprestimo_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_e_data_entrega_cond#NMF#' + search_get_sel_txt('SC_e_data_entrega_cond') + '@NMF@';
  str_out += 'SC_e_data_entrega_dia#NMF#' + search_get_sel_txt('SC_e_data_entrega_dia') + '@NMF@';
  str_out += 'SC_e_data_entrega_mes#NMF#' + search_get_sel_txt('SC_e_data_entrega_mes') + '@NMF@';
  str_out += 'SC_e_data_entrega_ano#NMF#' + search_get_sel_txt('SC_e_data_entrega_ano') + '@NMF@';
  str_out += 'SC_e_data_entrega_input_2_dia#NMF#' + search_get_sel_txt('SC_e_data_entrega_input_2_dia') + '@NMF@';
  str_out += 'SC_e_data_entrega_input_2_mes#NMF#' + search_get_sel_txt('SC_e_data_entrega_input_2_mes') + '@NMF@';
  str_out += 'SC_e_data_entrega_input_2_ano#NMF#' + search_get_sel_txt('SC_e_data_entrega_input_2_ano') + '@NMF@';
  str_out += 'SC_e_data_devolucao_cond#NMF#' + search_get_sel_txt('SC_e_data_devolucao_cond') + '@NMF@';
  str_out += 'SC_e_data_devolucao_dia#NMF#' + search_get_sel_txt('SC_e_data_devolucao_dia') + '@NMF@';
  str_out += 'SC_e_data_devolucao_mes#NMF#' + search_get_sel_txt('SC_e_data_devolucao_mes') + '@NMF@';
  str_out += 'SC_e_data_devolucao_ano#NMF#' + search_get_sel_txt('SC_e_data_devolucao_ano') + '@NMF@';
  str_out += 'SC_e_data_devolucao_input_2_dia#NMF#' + search_get_sel_txt('SC_e_data_devolucao_input_2_dia') + '@NMF@';
  str_out += 'SC_e_data_devolucao_input_2_mes#NMF#' + search_get_sel_txt('SC_e_data_devolucao_input_2_mes') + '@NMF@';
  str_out += 'SC_e_data_devolucao_input_2_ano#NMF#' + search_get_sel_txt('SC_e_data_devolucao_input_2_ano') + '@NMF@';
  str_out += 'SC_e_status_cond#NMF#' + search_get_sel_txt('SC_e_status_cond') + '@NMF@';
  str_out += 'SC_e_status#NMF#' + search_get_text('SC_e_status') + '@NMF@';
  str_out += 'id_ac_e_status#NMF#' + search_get_text('id_ac_e_status') + '@NMF@';
   ...
   $("#id_ac_e_status").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_e_status",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_e_status").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_e_status").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - </span></td>
...
<?php
   ...
   {
      global 
             $e_data_entrega_cond, $e_data_entrega, $e_data_entrega_dia, $e_data_entrega_mes, $e_data_entrega_ano, $e_data_entrega_input_2_dia, $e_data_entrega_input_2_mes, $e_data_entrega_input_2_ano,
             $e_data_devolucao_cond, $e_data_devolucao, $e_data_devolucao_dia, $e_data_devolucao_mes, $e_data_devolucao_ano, $e_data_devolucao_input_2_dia, $e_data_devolucao_input_2_mes, $e_data_devolucao_input_2_ano,
             $e_status_cond, $e_status, $e_status_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $e_data_entrega_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_entrega_dia']; 
          $e_data_entrega_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_entrega_mes']; 
          $e_data_entrega_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_entrega_ano']; 
          $e_data_entrega_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_entrega_input_2_dia']; 
          $e_data_entrega_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_entrega_input_2_mes']; 
          $e_data_entrega_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_entrega_input_2_ano']; 
          $e_data_entrega_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_entrega_cond']; 
          $e_data_devolucao_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_devolucao_dia']; 
          $e_data_devolucao_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_devolucao_mes']; 
          $e_data_devolucao_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_devolucao_ano']; 
          $e_data_devolucao_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_devolucao_input_2_dia']; 
          $e_data_devolucao_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_devolucao_input_2_mes']; 
          $e_data_devolucao_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_devolucao_input_2_ano']; 
          $e_data_devolucao_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_devolucao_cond']; 
          $e_status = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_status']; 
          $e_status_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_status_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['NM_operador']; 
      } 
      if (!isset($e_data_entrega_cond) || empty($e_data_entrega_cond))
      {
         $e_data_entrega_cond = "eq";
      }
      if (!isset($e_data_devolucao_cond) || empty($e_data_devolucao_cond))
      {
         $e_data_devolucao_cond = "eq";
      }
      if (!isset($e_status_cond) || empty($e_status_cond))
      {
         $e_status_cond = "qp";
      }
      ...
      $str_hide_e_data_entrega = (in_array($e_data_entrega_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_e_data_devolucao = (in_array($e_data_devolucao_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_e_status = (in_array($e_status_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_e_data_entrega = ('bw' == $e_data_entrega_cond) ? $display_aberto : $display_fechado;
      $str_display_e_data_devolucao = ('bw' == $e_data_devolucao_cond) ? $display_aberto : $display_fechado;

      if (!isset($e_data_entrega) || $e_data_entrega == "")
      {
          $e_data_entrega = "";
      }
      if (isset($e_data_entrega) && !empty($e_data_entrega))
      {
         $tmp_pos = strpos($e_data_entrega, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $e_data_entrega = substr($e_data_entrega, 0, $tmp_pos);
         }
      }
      if (!isset($e_data_devolucao) || $e_data_devolucao == "")
      {
          $e_data_devolucao = "";
      }
      if (isset($e_data_devolucao) && !empty($e_data_devolucao))
      {
         $tmp_pos = strpos($e_data_devolucao, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $e_data_devolucao = substr($e_data_devolucao, 0, $tmp_pos);
         }
      }
      ...
      if (isset($e_status) && !empty($e_status))
      {
         $tmp_pos = strpos($e_status, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $e_status = substr($e_status, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_relatorio_emprestimo_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['e_data_entrega'])) ? $this->New_label['e_data_entrega'] : "Data Entrega"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_e_data_entrega_cond" name="e_data_entrega_cond" onChange="nm_campos_between(document.getElementById('id_vis_e_data_entrega'), this, 'e_data_entrega')">
       <OPTION value="eq" <?php if ("eq" == $e_data_entrega_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $e_data_entrega_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $e_data_entrega_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $e_data_entrega_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_e_data_entrega" <?php echo $str_hide_e_data_entrega?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['e_data_entrega'])) ? $this->New_label['e_data_entrega'] : "Data Entrega";
 $nmgp_tab_label .= "e_data_entrega?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_e_data_entrega_dia" name="e_data_entrega_dia" value="<?php echo NM_encode_input($e_data_entrega_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.e_data_entrega_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_e_data_entrega_mes" name="e_data_entrega_mes" value="<?php echo NM_encode_input($e_data_entrega_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.e_data_entrega_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_e_data_entrega_ano" name="e_data_entrega_ano" value="<?php echo NM_encode_input($e_data_entrega_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
        <SPAN id="id_css_e_data_entrega"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_e_data_entrega"  <?php echo $str_display_e_data_entrega; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_e_data_entrega_input_2_dia" name="e_data_entrega_input_2_dia" value="<?php echo NM_encode_input($e_data_entrega_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.e_data_entrega_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_e_data_entrega_input_2_mes" name="e_data_entrega_input_2_mes" value="<?php echo NM_encode_input($e_data_entrega_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.e_data_entrega_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_e_data_entrega_input_2_ano" name="e_data_entrega_input_2_ano" value="<?php echo NM_encode_input($e_data_entrega_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['e_data_devolucao'])) ? $this->New_label['e_data_devolucao'] : "Data Devolucao"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_e_data_devolucao_cond" name="e_data_devolucao_cond" onChange="nm_campos_between(document.getElementById('id_vis_e_data_devolucao'), this, 'e_data_devolucao')">
       <OPTION value="eq" <?php if ("eq" == $e_data_devolucao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $e_data_devolucao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $e_data_devolucao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $e_data_devolucao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_e_data_devolucao" <?php echo $str_hide_e_data_devolucao?> valign="top">
 ...
 $nmgp_tab_label .= "e_data_devolucao?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_e_data_devolucao_dia" name="e_data_devolucao_dia" value="<?php echo NM_encode_input($e_data_devolucao_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.e_data_devolucao_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_e_data_devolucao_mes" name="e_data_devolucao_mes" value="<?php echo NM_encode_input($e_data_devolucao_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.e_data_devolucao_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_e_data_devolucao_ano" name="e_data_devolucao_ano" value="<?php echo NM_encode_input($e_data_devolucao_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
        <SPAN id="id_css_e_data_devolucao"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_e_data_devolucao"  <?php echo $str_display_e_data_devolucao; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>
         <BR>
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_e_data_devolucao_input_2_dia" name="e_data_devolucao_input_2_dia" value="<?php echo NM_encode_input($e_data_devolucao_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.e_data_devolucao_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_e_data_devolucao_input_2_mes" name="e_data_devolucao_input_2_mes" value="<?php echo NM_encode_input($e_data_devolucao_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.e_data_devolucao_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_e_data_devolucao_input_2_ano" name="e_data_devolucao_input_2_ano" value="<?php echo NM_encode_input($e_data_devolucao_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['e_status'])) ? $this->New_label['e_status'] : "Status"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_e_status_cond" name="e_status_cond" onChange="nm_campos_between(document.getElementById('id_vis_e_status'), this, 'e_status')">
       <OPTION value="qp" <?php if ("qp" == $e_status_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $e_status_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $e_status_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $e_status_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_e_status" <?php echo $str_hide_e_status?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['e_status'])) ? $this->New_label['e_status'] : "Status";
 $nmgp_tab_label .= "e_status?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $e_status_look = substr($this->Db->qstr($e_status), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct e.status from " . $this->Ini->nm_tabela . " where e.status = 'emprestado' && e.id_aluno = a.id_aluno && e.id_estoque_livro = es.id_estoque_livro and e.status = '$e_status_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$e_status]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$e_status];
      }
      else
      {
          $sAutocompValue = $e_status;
      }
?>
<INPUT  type="text" id="SC_e_status" name="e_status" value="<?php echo NM_encode_input($e_status) ?>" size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_e_status" name="e_status_autocomp" size="20" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_relatorio_emprestimo']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_relatorio_emprestimo']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_e_data_entrega'), document.F1.e_data_entrega_cond, 'e_data_entrega');
   document.F1.e_data_entrega_dia.value = "";
   document.F1.e_data_entrega_mes.value = "";
   document.F1.e_data_entrega_ano.value = "";
   document.F1.e_data_entrega_input_2_dia.value = "";
   document.F1.e_data_entrega_input_2_mes.value = "";
   document.F1.e_data_entrega_input_2_ano.value = "";
   nm_campos_between(document.getElementById('id_vis_e_data_devolucao'), document.F1.e_data_devolucao_cond, 'e_data_devolucao');
   document.F1.e_data_devolucao_dia.value = "";
   document.F1.e_data_devolucao_mes.value = "";
   document.F1.e_data_devolucao_ano.value = "";
   document.F1.e_data_devolucao_input_2_dia.value = "";
   document.F1.e_data_devolucao_input_2_mes.value = "";
   document.F1.e_data_devolucao_input_2_ano.value = "";
   nm_campos_between(document.getElementById('id_vis_e_status'), document.F1.e_status_cond, 'e_status');
   document.F1.e_status.value = "";
   document.F1.e_status_autocomp.value = "";
 }
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_e_data_devolucao_dia').bind('change', function() {sc_grid_relatorio_emprestimo_valida_dia(this)});
    $('#SC_e_data_devolucao_input_2_dia').bind('change', function() {sc_grid_relatorio_emprestimo_valida_dia(this)});
    $('#SC_e_data_devolucao_input_2_mes').bind('change', function() {sc_grid_relatorio_emprestimo_valida_mes(this)});
    $('#SC_e_data_devolucao_mes').bind('change', function() {sc_grid_relatorio_emprestimo_valida_mes(this)});
    $('#SC_e_data_entrega_dia').bind('change', function() {sc_grid_relatorio_emprestimo_valida_dia(this)});
    $('#SC_e_data_entrega_input_2_dia').bind('change', function() {sc_grid_relatorio_emprestimo_valida_dia(this)});
    $('#SC_e_data_entrega_input_2_mes').bind('change', function() {sc_grid_relatorio_emprestimo_valida_mes(this)});
    $('#SC_e_data_entrega_mes').bind('change', function() {sc_grid_relatorio_emprestimo_valida_mes(this)});
 }
 function sc_grid_relatorio_emprestimo_valida_dia(obj)
 {
 ...
 function sc_grid_relatorio_emprestimo_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "SAE/grid_relatorio_emprestimo";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_relatorio_emprestimo/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_e_data_entrega_cond'] = 'cond';
      $tp_fields['SC_e_data_entrega_dia'] = 'text';
      $tp_fields['SC_e_data_entrega_mes'] = 'text';
      $tp_fields['SC_e_data_entrega_ano'] = 'text';
      $tp_fields['SC_e_data_entrega_input_2_dia'] = 'text';
      $tp_fields['SC_e_data_entrega_input_2_mes'] = 'text';
      $tp_fields['SC_e_data_entrega_input_2_ano'] = 'text';
      $tp_fields['SC_e_data_devolucao_cond'] = 'cond';
      $tp_fields['SC_e_data_devolucao_dia'] = 'text';
      $tp_fields['SC_e_data_devolucao_mes'] = 'text';
      $tp_fields['SC_e_data_devolucao_ano'] = 'text';
      $tp_fields['SC_e_data_devolucao_input_2_dia'] = 'text';
      $tp_fields['SC_e_data_devolucao_input_2_mes'] = 'text';
      $tp_fields['SC_e_data_devolucao_input_2_ano'] = 'text';
      $tp_fields['SC_e_status_cond'] = 'cond';
      $tp_fields['SC_e_status'] = 'text_aut';
      $tp_fields['id_ac_e_status'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $e_data_entrega_cond, $e_data_entrega, $e_data_entrega_dia, $e_data_entrega_mes, $e_data_entrega_ano, $e_data_entrega_input_2_dia, $e_data_entrega_input_2_mes, $e_data_entrega_input_2_ano,
             $e_data_devolucao_cond, $e_data_devolucao, $e_data_devolucao_dia, $e_data_devolucao_mes, $e_data_devolucao_ano, $e_data_devolucao_input_2_dia, $e_data_devolucao_input_2_mes, $e_data_devolucao_input_2_ano,
             $e_status_cond, $e_status, $e_status_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($e_status_autocomp) && empty($e_status))
      {
          $e_status = $e_status_autocomp;
      }
      $e_data_entrega_cond_salva = $e_data_entrega_cond; 
      if (!isset($e_data_entrega_input_2_dia) || $e_data_entrega_input_2_dia == "")
      {
          $e_data_entrega_input_2_dia = $e_data_entrega_dia;
      }
      if (!isset($e_data_entrega_input_2_mes) || $e_data_entrega_input_2_mes == "")
      {
          $e_data_entrega_input_2_mes = $e_data_entrega_mes;
      }
      if (!isset($e_data_entrega_input_2_ano) || $e_data_entrega_input_2_ano == "")
      {
          $e_data_entrega_input_2_ano = $e_data_entrega_ano;
      }
      $e_data_devolucao_cond_salva = $e_data_devolucao_cond; 
      if (!isset($e_data_devolucao_input_2_dia) || $e_data_devolucao_input_2_dia == "")
      {
          $e_data_devolucao_input_2_dia = $e_data_devolucao_dia;
      }
      if (!isset($e_data_devolucao_input_2_mes) || $e_data_devolucao_input_2_mes == "")
      {
          $e_data_devolucao_input_2_mes = $e_data_devolucao_mes;
      }
      if (!isset($e_data_devolucao_input_2_ano) || $e_data_devolucao_input_2_ano == "")
      {
          $e_data_devolucao_input_2_ano = $e_data_devolucao_ano;
      }
      $e_status_cond_salva = $e_status_cond; 
      if (!isset($e_status_input_2) || $e_status_input_2 == "")
      {
          $e_status_input_2 = $e_status;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_entrega_dia'] = $e_data_entrega_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_entrega_mes'] = $e_data_entrega_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_entrega_ano'] = $e_data_entrega_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_entrega_input_2_dia'] = $e_data_entrega_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_entrega_input_2_mes'] = $e_data_entrega_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_entrega_input_2_ano'] = $e_data_entrega_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_entrega_cond'] = $e_data_entrega_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_devolucao_dia'] = $e_data_devolucao_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_devolucao_mes'] = $e_data_devolucao_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_devolucao_ano'] = $e_data_devolucao_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_devolucao_input_2_dia'] = $e_data_devolucao_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_devolucao_input_2_mes'] = $e_data_devolucao_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_devolucao_input_2_ano'] = $e_data_devolucao_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_devolucao_cond'] = $e_data_devolucao_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_status'] = $e_status; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_status_cond'] = $e_status_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['e_status'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['e_status'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['e_status'] = $e_status;
      }

      //----- $e_data_entrega
      $this->Date_part = false;
      if ($e_data_entrega_cond != "TP")
      {
          $e_data_entrega_cond = strtoupper($e_data_entrega_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $e_data_entrega_ano;
          $Dtxt .= $e_data_entrega_mes;
          $Dtxt .= $e_data_entrega_dia;
          $val[0]['ano'] = $e_data_entrega_ano;
          $val[0]['mes'] = $e_data_entrega_mes;
          $val[0]['dia'] = $e_data_entrega_dia;
          if ($e_data_entrega_cond == "BW")
          {
              $val[1]['ano'] = $e_data_entrega_input_2_ano;
              $val[1]['mes'] = $e_data_entrega_input_2_mes;
              $val[1]['dia'] = $e_data_entrega_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $e_data_entrega_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $e_data_entrega_cond , "", "data");
          }
          $e_data_entrega = $val[0];
          $this->cmp_formatado['e_data_entrega'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_entrega'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['e_data_entrega'], "YYYY-MM-DD");
          $this->cmp_formatado['e_data_entrega'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($e_data_entrega_cond == "BW")
          {
              $e_data_entrega_input_2     = $val[1];
              $this->cmp_formatado['e_data_entrega_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_entrega_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['e_data_entrega_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['e_data_entrega_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $e_data_entrega_cond == "NU" || $e_data_entrega_cond == "NN"|| $e_data_entrega_cond == "EP"|| $e_data_entrega_cond == "NE")
          {
              $this->monta_condicao("e.data_entrega", $e_data_entrega_cond, $e_data_entrega, $e_data_entrega_input_2, 'e_data_entrega', 'DATE');
          }
      }

      //----- $e_data_devolucao
      $this->Date_part = false;
      if ($e_data_devolucao_cond != "TP")
      {
          $e_data_devolucao_cond = strtoupper($e_data_devolucao_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $e_data_devolucao_ano;
          $Dtxt .= $e_data_devolucao_mes;
          $Dtxt .= $e_data_devolucao_dia;
          $val[0]['ano'] = $e_data_devolucao_ano;
          $val[0]['mes'] = $e_data_devolucao_mes;
          $val[0]['dia'] = $e_data_devolucao_dia;
          if ($e_data_devolucao_cond == "BW")
          {
              $val[1]['ano'] = $e_data_devolucao_input_2_ano;
              $val[1]['mes'] = $e_data_devolucao_input_2_mes;
              $val[1]['dia'] = $e_data_devolucao_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $e_data_devolucao_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $e_data_devolucao_cond , "", "data");
          }
          $e_data_devolucao = $val[0];
          $this->cmp_formatado['e_data_devolucao'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_devolucao'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['e_data_devolucao'], "YYYY-MM-DD");
          $this->cmp_formatado['e_data_devolucao'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($e_data_devolucao_cond == "BW")
          {
              $e_data_devolucao_input_2     = $val[1];
              $this->cmp_formatado['e_data_devolucao_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']['e_data_devolucao_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['e_data_devolucao_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['e_data_devolucao_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $e_data_devolucao_cond == "NU" || $e_data_devolucao_cond == "NN"|| $e_data_devolucao_cond == "EP"|| $e_data_devolucao_cond == "NE")
          {
              $this->monta_condicao("e.data_devolucao", $e_data_devolucao_cond, $e_data_devolucao, $e_data_devolucao_input_2, 'e_data_devolucao', 'DATE');
          }
      }

      //----- $e_status
      $this->Date_part = false;
      if (isset($e_status) || $e_status_cond == "nu" || $e_status_cond == "nn" || $e_status_cond == "ep" || $e_status_cond == "ne")
      {
         $this->monta_condicao("e.status", $e_status_cond, $e_status, "", "e_status");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_emprestimo']['where_pesq_ant'] = $this->comando . $this->comando_fim;
