...
<?php
include_once("control_acompanhamento_domiciliar_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_acompanhamento_domiciliar_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar']['recarga'];
}
?>
...
<?php
 include_once("control_acompanhamento_domiciliar_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_acompanhamento_domiciliar'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_acompanhamento_domiciliar'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  if ($this->nmgp_form_empty)
  {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar']['empty_filter'] = true;
       }
  }
  else
  {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_motivo_label" id="hidden_field_label_motivo" style="<?php echo $sStyleHidden_motivo; ?>"><span id="id_label_motivo"><?php echo $this->nm_new_label['motivo']; ?></span></TD>
    <TD class="scFormDataOdd css_motivo_line" id="hidden_field_data_motivo" style="<?php echo $sStyleHidden_motivo; ?>">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_data_line" id="hidden_field_data_data" style="<?php echo $sStyleHidden_data; ?>">
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_acompanhamento_domiciliar");
 parent.scAjaxDetailHeight("control_acompanhamento_domiciliar", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
