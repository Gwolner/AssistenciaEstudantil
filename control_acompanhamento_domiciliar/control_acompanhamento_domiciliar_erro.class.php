...
class control_acompanhamento_domiciliar_erro
{
   var $Ini;
   ...
   //----- 
   function control_acompanhamento_domiciliar_erro()
   {
      $this->script      = "";
      $this->linha       = "";
      $this->tipo        = "";
   ...
   function mensagem($script, $linha, $tipo, $mensagem, $complemento = "", $exibe = true)
   {
      ...
      $this->monta_mensagem();
      return control_acompanhamento_domiciliar_scriptcase_error_handler(E_USER_ERROR, $this->msg_final, $script, $linha, $exibe);
   }
