  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_acompanhamento_domiciliar_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate nome
  function do_ajax_control_acompanhamento_domiciliar_mob_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_acompanhamento_domiciliar_mob_validate_nome(var_nome, var_script_case_init, do_ajax_control_acompanhamento_domiciliar_mob_validate_nome_cb);
  } // do_ajax_control_acompanhamento_domiciliar_mob_validate_nome

  function do_ajax_control_acompanhamento_domiciliar_mob_validate_nome_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_acompanhamento_domiciliar_mob_validate_nome_cb

  // ---------- Validate matricula
  function do_ajax_control_acompanhamento_domiciliar_mob_validate_matricula()
  {
    var nomeCampo_matricula = "matricula";
    var var_matricula = scAjaxGetFieldText(nomeCampo_matricula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_acompanhamento_domiciliar_mob_validate_matricula(var_matricula, var_script_case_init, do_ajax_control_acompanhamento_domiciliar_mob_validate_matricula_cb);
  } // do_ajax_control_acompanhamento_domiciliar_mob_validate_matricula

  function do_ajax_control_acompanhamento_domiciliar_mob_validate_matricula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_acompanhamento_domiciliar_mob_validate_matricula_cb

  // ---------- Validate periodo
  function do_ajax_control_acompanhamento_domiciliar_mob_validate_periodo()
  {
    var nomeCampo_periodo = "periodo";
    var var_periodo = scAjaxGetFieldText(nomeCampo_periodo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_acompanhamento_domiciliar_mob_validate_periodo(var_periodo, var_script_case_init, do_ajax_control_acompanhamento_domiciliar_mob_validate_periodo_cb);
  } // do_ajax_control_acompanhamento_domiciliar_mob_validate_periodo

  function do_ajax_control_acompanhamento_domiciliar_mob_validate_periodo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "periodo";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_acompanhamento_domiciliar_mob_validate_periodo_cb

  // ---------- Validate motivo
  function do_ajax_control_acompanhamento_domiciliar_mob_validate_motivo()
  {
    var nomeCampo_motivo = "motivo";
    var var_motivo = scAjaxGetFieldText(nomeCampo_motivo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_acompanhamento_domiciliar_mob_validate_motivo(var_motivo, var_script_case_init, do_ajax_control_acompanhamento_domiciliar_mob_validate_motivo_cb);
  } // do_ajax_control_acompanhamento_domiciliar_mob_validate_motivo

  function do_ajax_control_acompanhamento_domiciliar_mob_validate_motivo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "motivo";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_acompanhamento_domiciliar_mob_validate_motivo_cb

  // ---------- Validate data
  function do_ajax_control_acompanhamento_domiciliar_mob_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_acompanhamento_domiciliar_mob_validate_data(var_data, var_script_case_init, do_ajax_control_acompanhamento_domiciliar_mob_validate_data_cb);
  } // do_ajax_control_acompanhamento_domiciliar_mob_validate_data

  function do_ajax_control_acompanhamento_domiciliar_mob_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "data";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_acompanhamento_domiciliar_mob_validate_data_cb
  // ---------- Form
  function do_ajax_control_acompanhamento_domiciliar_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_acompanhamento_domiciliar_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nome = scAjaxGetFieldText("nome");
    var var_matricula = scAjaxGetFieldText("matricula");
    var var_periodo = scAjaxGetFieldText("periodo");
    var var_motivo = scAjaxGetFieldText("motivo");
    ...
    scAjaxProcOn();
    x_ajax_control_acompanhamento_domiciliar_mob_submit_form(var_nome, var_matricula, var_periodo, var_motivo, var_data, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_acompanhamento_domiciliar_mob_submit_form_cb);
  } // do_ajax_control_acompanhamento_domiciliar_mob_submit_form

  function do_ajax_control_acompanhamento_domiciliar_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_acompanhamento_domiciliar_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_acompanhamento_domiciliar_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_acompanhamento_domiciliar_mob_navigate_form

  function do_ajax_control_acompanhamento_domiciliar_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_acompanhamento_domiciliar_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_acompanhamento_domiciliar_mob_navigate_form_cb
  function sc_hide_control_acompanhamento_domiciliar_mob_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_acompanhamento_domiciliar_mob_form
  ...
  ajax_field_list[0] = "nome";
  ajax_field_list[1] = "matricula";
  ajax_field_list[2] = "periodo";
  ajax_field_list[3] = "motivo";
  ajax_field_list[4] = "data";
  ...
  var ajax_error_list = {
    ...
    "periodo": {"label": "Período", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
