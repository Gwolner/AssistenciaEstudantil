...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . ""); } else { echo strip_tags("Ficha de acompanhamento familiar"); } ?></TITLE>
...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>control_acompanhamento_domiciliar/control_acompanhamento_domiciliar_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("control_acompanhamento_domiciliar_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_acompanhamento_domiciliar_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar_mob']['recarga'];
}
?>
...
<?php
 include_once("control_acompanhamento_domiciliar_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" 
               action="control_acompanhamento_domiciliar_mob.php" 
               target="_self"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_acompanhamento_domiciliar_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_acompanhamento_domiciliar_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . ""; } else { echo "Ficha de acompanhamento familiar"; } ?></span></td>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar_mob']['empty_filter'] = true;
       }
  }
  else
  {
...
<span id="id_read_on_nome" class="sc-ui-readonly-nome css_nome_line" style="<?php echo $sStyleReadLab_nome; ?>"><?php echo $this->form_encode_input($this->nome); ?></span><span id="id_read_off_nome" style="white-space: nowrap;<?php echo $sStyleReadInp_nome; ?>">
 ...
 size=70 maxlength=100 alt="{datatype: 'text', maxLength: 100, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_matricula_line" id="hidden_field_data_matricula" style="<?php echo $sStyleHidden_matricula; ?>"> <span class="scFormLabelOddFormat css_matricula_label"><span id="id_label_matricula"><?php echo $this->nm_new_label['matricula']; ?></span></span><br>
...
<span id="id_read_on_matricula" class="sc-ui-readonly-matricula css_matricula_line" style="<?php echo $sStyleReadLab_matricula; ?>"><?php echo $this->form_encode_input($this->matricula); ?></span><span id="id_read_off_matricula" style="white-space: nowrap;<?php echo $sStyleReadInp_matricula; ?>">
 ...
 size=15 maxlength=16 alt="{datatype: 'text', maxLength: 16, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
 </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['periodo'] = "Período";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_periodo_line" id="hidden_field_data_periodo" style="<?php echo $sStyleHidden_periodo; ?>"> <span class="scFormLabelOddFormat css_periodo_label"><span id="id_label_periodo"><?php echo $this->nm_new_label['periodo']; ?></span></span><br>
...
<span id="id_read_on_periodo" class="sc-ui-readonly-periodo css_periodo_line" style="<?php echo $sStyleReadLab_periodo; ?>"><?php echo $this->form_encode_input($this->periodo); ?></span><span id="id_read_off_periodo" style="white-space: nowrap;<?php echo $sStyleReadInp_periodo; ?>">
 ...
 size=15 alt="{datatype: 'integer', maxLength: 2, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['periodo']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['periodo']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_motivo_line" id="hidden_field_data_motivo" style="<?php echo $sStyleHidden_motivo; ?>"> <span class="scFormLabelOddFormat css_motivo_label"><span id="id_label_motivo"><?php echo $this->nm_new_label['motivo']; ?></span></span><br>
<?php
$motivo_val = str_replace('<br />', '__SC_BREAK_LINE__', nl2br($motivo));
...
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["motivo"]) &&  $this->nmgp_cmp_readonly["motivo"] == "on") { 
 ...
 ?>
<input type="hidden" name="motivo" value="<?php echo $this->form_encode_input($motivo) . "\">" . $motivo_val . ""; ?>
<?php } else { ?>
<span id="id_read_on_motivo" class="sc-ui-readonly-motivo css_motivo_line" style="<?php echo $sStyleReadLab_motivo; ?>"><?php echo $this->form_encode_input($motivo_val); ?></span><span id="id_read_off_motivo" style="white-space: nowrap;<?php echo $sStyleReadInp_motivo; ?>">
 <textarea  class="sc-js-input scFormObjectOdd css_motivo_obj" style="white-space: pre-wrap;" name="motivo" id="id_sc_field_motivo" rows="20" cols="85"
 alt="{datatype: 'text', maxLength: 5000, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}">
<?php echo $motivo; ?>
</textarea>
</span><?php } ?>
 </TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_data_line" id="hidden_field_data_data" style="<?php echo $sStyleHidden_data; ?>"> <span class="scFormLabelOddFormat css_data_label"><span id="id_label_data"><?php echo $this->nm_new_label['data']; ?></span></span><br>
...
<?php } else { ?>
<span id="id_read_on_data" class="sc-ui-readonly-data css_data_line" style="<?php echo $sStyleReadLab_data; ?>"><?php echo $this->form_encode_input($data); ?></span><span id="id_read_off_data" style="white-space: nowrap;<?php echo $sStyleReadInp_data; ?>">
 <input class="sc-js-input scFormObjectOdd css_data_obj" style="" id="id_sc_field_data" type=text name="data" value="<?php echo $this->form_encode_input($data) ?>"
 size=10 alt="{datatype: 'date', dateSep: '<?php echo $this->field_config['data']['date_sep']; ?>', dateFormat: '<?php echo $this->field_config['data']['date_format']; ?>', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"><?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_acompanhamento_domiciliar_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("control_acompanhamento_domiciliar_mob");
 parent.scAjaxDetailHeight("control_acompanhamento_domiciliar_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
