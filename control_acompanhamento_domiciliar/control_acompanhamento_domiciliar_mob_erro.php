...
$old_error_handler = set_error_handler("control_acompanhamento_domiciliar_mob_scriptcase_error_handler");

function control_acompanhamento_domiciliar_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['control_acompanhamento_domiciliar_mob']['contr_erro']) && $_SESSION['scriptcase']['control_acompanhamento_domiciliar_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_control_acompanhamento_domiciliar_mob->contr_control_acompanhamento_domiciliar_mob->Apl_com_erro = true;
            if ($inicial_control_acompanhamento_domiciliar_mob->contr_control_acompanhamento_domiciliar_mob->NM_ajax_flag)
            {
                $inicial_control_acompanhamento_domiciliar_mob->contr_control_acompanhamento_domiciliar_mob->NM_ajax_info['errList']['geral_control_acompanhamento_domiciliar_mob'][] = $msg;
                return;
            }
            control_acompanhamento_domiciliar_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function control_acompanhamento_domiciliar_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['control_acompanhamento_domiciliar_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['control_acompanhamento_domiciliar_mob'])  ? $_SESSION['scriptcase']['error_icon']['control_acompanhamento_domiciliar_mob']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['control_acompanhamento_domiciliar_mob']) && '' != $_SESSION['scriptcase']['error_close']['control_acompanhamento_domiciliar_mob']) ? $_SESSION['scriptcase']['error_close']['control_acompanhamento_domiciliar_mob'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['control_acompanhamento_domiciliar_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['control_acompanhamento_domiciliar_mob']) ? $_SESSION['scriptcase']['error_span_title']['control_acompanhamento_domiciliar_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['control_acompanhamento_domiciliar_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['control_acompanhamento_domiciliar_mob']) ? $_SESSION['scriptcase']['error_icon_title']['control_acompanhamento_domiciliar_mob'] : '';
?>
<DIV id="id_error_display_fixed" style="position: absolute; z-index: 1000"><TABLE class="scFormErrorTable" align="center">
 <TR>
<?php
        if ($bSpanTitle && '' != $sIconTitle)
        {
?>
  <td style="padding: 0px" rowspan="2"><img src="<?php echo $sIconTitle; ?>" style="border-width: 0px" align="top"></td>
<?php
        }
?>
