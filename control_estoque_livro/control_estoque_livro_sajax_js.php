  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_estoque_livro" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate livro
  function do_ajax_control_estoque_livro_validate_livro()
  {
  } // do_ajax_control_estoque_livro_validate_livro

  function do_ajax_control_estoque_livro_validate_livro_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_estoque_livro_validate_livro_cb

  // ---------- Event onclick scajaxbutton_novo
  function do_ajax_control_estoque_livro_event_scajaxbutton_novo_onclick()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_estoque_livro_event_scajaxbutton_novo_onclick(var_script_case_init, do_ajax_control_estoque_livro_event_scajaxbutton_novo_onclick_cb);
  } // do_ajax_control_estoque_livro_event_scajaxbutton_novo_onclick

  function do_ajax_control_estoque_livro_event_scajaxbutton_novo_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_estoque_livro_event_scajaxbutton_novo_onclick_cb
  // ---------- Form
  function do_ajax_control_estoque_livro_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_estoque_livro_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_estoque_livro_submit_form(var_livro, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_estoque_livro_submit_form_cb);
  } // do_ajax_control_estoque_livro_submit_form

  function do_ajax_control_estoque_livro_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_estoque_livro_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_estoque_livro_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_estoque_livro_navigate_form

  function do_ajax_control_estoque_livro_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_estoque_livro_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_estoque_livro_navigate_form_cb
  function sc_hide_control_estoque_livro_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_estoque_livro_form
