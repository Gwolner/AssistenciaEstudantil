  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_estoque_livro_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate livro
  function do_ajax_control_estoque_livro_mob_validate_livro()
  {
  } // do_ajax_control_estoque_livro_mob_validate_livro

  function do_ajax_control_estoque_livro_mob_validate_livro_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_estoque_livro_mob_validate_livro_cb

  // ---------- Event onclick scajaxbutton_novo
  function do_ajax_control_estoque_livro_mob_event_scajaxbutton_novo_onclick()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_estoque_livro_mob_event_scajaxbutton_novo_onclick(var_script_case_init, do_ajax_control_estoque_livro_mob_event_scajaxbutton_novo_onclick_cb);
  } // do_ajax_control_estoque_livro_mob_event_scajaxbutton_novo_onclick

  function do_ajax_control_estoque_livro_mob_event_scajaxbutton_novo_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "scajaxbutton_novo";
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_estoque_livro_mob_event_scajaxbutton_novo_onclick_cb
  // ---------- Form
  function do_ajax_control_estoque_livro_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_estoque_livro_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_livro = scAjaxGetFieldText("livro");
    ...
    scAjaxProcOn();
    x_ajax_control_estoque_livro_mob_submit_form(var_livro, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_estoque_livro_mob_submit_form_cb);
  } // do_ajax_control_estoque_livro_mob_submit_form

  function do_ajax_control_estoque_livro_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_estoque_livro_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_estoque_livro_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_estoque_livro_mob_navigate_form

  function do_ajax_control_estoque_livro_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_estoque_livro_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_estoque_livro_mob_navigate_form_cb
  function sc_hide_control_estoque_livro_mob_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_estoque_livro_mob_form
  ...
  ajax_field_list[0] = "livro";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "livro": {"label": "Livro", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["livro"][1] = "livro";

  var ajax_field_id = {
    "livro": new Array("hidden_field_label_livro", "hidden_field_data_livro")
  };
