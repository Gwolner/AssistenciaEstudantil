...
class control_login_mob_erro
{
   ...
   //----- 
   function control_login_mob_erro()
   {
      $this->script      = "";
      $this->linha       = "";
      $this->tipo        = "";
   ...
   function mensagem($script, $linha, $tipo, $mensagem, $complemento = "", $exibe = true)
   {
      ...
      $this->monta_mensagem();
      return control_login_mob_scriptcase_error_handler(E_USER_ERROR, $this->msg_final, $script, $linha, $exibe);
   }
