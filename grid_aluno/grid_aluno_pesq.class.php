...
//-- ajax metodos ---
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_aluno')
      {
          $id_aluno = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_aluno($id_aluno);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nome_aluno')
      {
          $nome_aluno = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nome_aluno($nome_aluno);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_curso')
      {
          $curso = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_curso($curso);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
      ...
      if ($this->NM_ajax_opcao == 'autocomp_turno')
      {
          $turno = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_turno($turno);
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
          foreach ($nmgp_def_dados as $Ind => $Lista)
   ...
   function lookup_ajax_id_aluno($id_aluno)
   {
      $id_aluno = substr($this->Db->qstr($id_aluno), 1, -1);
            $id_aluno_look = substr($this->Db->qstr($id_aluno), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_aluno from " . $this->Ini->nm_tabela . " where   CAST (id_aluno AS TEXT)  like '%" . $id_aluno . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct id_aluno from " . $this->Ini->nm_tabela . " where  id_aluno like '%" . $id_aluno . "%'"; 
      }
   ...
   function lookup_ajax_nome_aluno($nome_aluno)
   {
      $nome_aluno = substr($this->Db->qstr($nome_aluno), 1, -1);
            $nome_aluno_look = substr($this->Db->qstr($nome_aluno), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nome_aluno from " . $this->Ini->nm_tabela . " where  nome_aluno like '%" . $nome_aluno . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_curso($curso)
   {
      $curso = substr($this->Db->qstr($curso), 1, -1);
            $curso_look = substr($this->Db->qstr($curso), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct curso from " . $this->Ini->nm_tabela . " where  curso like '%" . $curso . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_turno($turno)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct turno from " . $this->Ini->nm_tabela . " where  turno like '%" . $turno . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      else
      {
         ...
         switch ($condicao)
         {
             ...
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
            ...
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
            ...
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
            ...
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - aluno</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_aluno/grid_aluno_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_aluno_ajax_search.js"></script>
 <script type="text/javascript" src="grid_aluno_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_id_aluno_cond#NMF#' + search_get_sel_txt('SC_id_aluno_cond') + '@NMF@';
  str_out += 'SC_id_aluno#NMF#' + search_get_text('SC_id_aluno') + '@NMF@';
  str_out += 'id_ac_id_aluno#NMF#' + search_get_text('id_ac_id_aluno') + '@NMF@';
  str_out += 'SC_id_aluno_input_2#NMF#' + search_get_text('SC_id_aluno_input_2') + '@NMF@';
  str_out += 'SC_nome_aluno_cond#NMF#' + search_get_sel_txt('SC_nome_aluno_cond') + '@NMF@';
  str_out += 'SC_nome_aluno#NMF#' + search_get_text('SC_nome_aluno') + '@NMF@';
  str_out += 'id_ac_nome_aluno#NMF#' + search_get_text('id_ac_nome_aluno') + '@NMF@';
  str_out += 'SC_curso_cond#NMF#' + search_get_sel_txt('SC_curso_cond') + '@NMF@';
  str_out += 'SC_curso#NMF#' + search_get_text('SC_curso') + '@NMF@';
  str_out += 'id_ac_curso#NMF#' + search_get_text('id_ac_curso') + '@NMF@';
  str_out += 'SC_turno_cond#NMF#' + search_get_sel_txt('SC_turno_cond') + '@NMF@';
  str_out += 'SC_turno#NMF#' + search_get_text('SC_turno') + '@NMF@';
  str_out += 'id_ac_turno#NMF#' + search_get_text('id_ac_turno') + '@NMF@';
   ...
   $("#id_ac_id_aluno").autocomplete({
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_id_aluno",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_id_aluno").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_id_aluno").val( $(this).val() );
       }
     }
   });
   $("#id_ac_nome_aluno").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nome_aluno",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_nome_aluno").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nome_aluno").val( $(this).val() );
       }
     }
   });
   $("#id_ac_curso").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_curso",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_curso").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_curso").val( $(this).val() );
       }
     }
   });
   $("#id_ac_turno").autocomplete({
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       dataType: "json",
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_turno",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_turno").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_turno").val( $(this).val() );
       }
     }
   });
 });
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - aluno</span></td>
...
<?php
   ...
   {
      global 
             $id_aluno_cond, $id_aluno, $id_aluno_input_2, $id_aluno_autocomp,
             $nome_aluno_cond, $nome_aluno, $nome_aluno_autocomp,
             $curso_cond, $curso, $curso_autocomp,
             $turno_cond, $turno, $turno_autocomp,
      ...
      { 
          ...
          $id_aluno = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']['id_aluno']; 
          $id_aluno_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']['id_aluno_input_2']; 
          $id_aluno_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']['id_aluno_cond']; 
          $nome_aluno = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']['nome_aluno']; 
          $nome_aluno_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']['nome_aluno_cond']; 
          $curso = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']['curso']; 
          $curso_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']['curso_cond']; 
          $turno = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']['turno']; 
          $turno_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']['turno_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']['NM_operador']; 
      } 
      if (!isset($id_aluno_cond) || empty($id_aluno_cond))
      {
         $id_aluno_cond = "gt";
      }
      if (!isset($nome_aluno_cond) || empty($nome_aluno_cond))
      {
         $nome_aluno_cond = "qp";
      }
      if (!isset($curso_cond) || empty($curso_cond))
      {
         $curso_cond = "qp";
      }
      ...
      $str_hide_id_aluno = (in_array($id_aluno_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nome_aluno = (in_array($nome_aluno_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_curso = (in_array($curso_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_turno = (in_array($turno_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_id_aluno = ('bw' == $id_aluno_cond) ? $display_aberto : $display_fechado;

      if (!isset($id_aluno) || $id_aluno == "")
      {
          $id_aluno = "";
      }
      if (isset($id_aluno) && !empty($id_aluno))
      {
         $tmp_pos = strpos($id_aluno, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_aluno = substr($id_aluno, 0, $tmp_pos);
         }
      }
      if (!isset($nome_aluno) || $nome_aluno == "")
      {
          $nome_aluno = "";
      }
      if (isset($nome_aluno) && !empty($nome_aluno))
      {
         $tmp_pos = strpos($nome_aluno, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nome_aluno = substr($nome_aluno, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($curso, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $curso = substr($curso, 0, $tmp_pos);
         }
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_aluno'])) ? $this->New_label['id_aluno'] : "Id Aluno"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_id_aluno_cond" name="id_aluno_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_aluno'), this, 'id_aluno')">
       <OPTION value="gt" <?php if ("gt" == $id_aluno_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_aluno_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_aluno_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $id_aluno_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_aluno" <?php echo $str_hide_id_aluno?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['id_aluno'])) ? $this->New_label['id_aluno'] : "Id Aluno";
 $nmgp_tab_label .= "id_aluno?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $id_aluno_look = substr($this->Db->qstr($id_aluno), 1, -1); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct id_aluno from " . $this->Ini->nm_tabela . " where id_aluno = $id_aluno_look"; 
      }
      else
      {
          $nm_comando = "select distinct id_aluno from " . $this->Ini->nm_tabela . " where id_aluno = $id_aluno_look"; 
      ...
      if (isset($nmgp_def_dados[0][$id_aluno]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_aluno];
      }
      else
      {
          $sAutocompValue = $id_aluno;
      }
?>
<INPUT  type="text" id="SC_id_aluno" name="id_aluno" value="<?php echo NM_encode_input($id_aluno) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id_aluno" name="id_aluno_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_id_aluno"  <?php echo $str_display_id_aluno; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_aluno_input_2" name="id_aluno_input_2" value="<?php echo NM_encode_input($id_aluno_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['nome_aluno'])) ? $this->New_label['nome_aluno'] : "Nome Aluno"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_nome_aluno_cond" name="nome_aluno_cond" onChange="nm_campos_between(document.getElementById('id_vis_nome_aluno'), this, 'nome_aluno')">
       <OPTION value="qp" <?php if ("qp" == $nome_aluno_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nome_aluno_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nome_aluno_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nome_aluno_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nome_aluno" <?php echo $str_hide_nome_aluno?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['nome_aluno'])) ? $this->New_label['nome_aluno'] : "Nome Aluno";
 $nmgp_tab_label .= "nome_aluno?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      $nome_aluno_look = substr($this->Db->qstr($nome_aluno), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nome_aluno from " . $this->Ini->nm_tabela . " where nome_aluno = '$nome_aluno_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$nome_aluno]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$nome_aluno];
      }
      else
      {
          $sAutocompValue = $nome_aluno;
      }
?>
<INPUT  type="text" id="SC_nome_aluno" name="nome_aluno" value="<?php echo NM_encode_input($nome_aluno) ?>" size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nome_aluno" name="nome_aluno_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['curso'])) ? $this->New_label['curso'] : "Curso"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_curso_cond" name="curso_cond" onChange="nm_campos_between(document.getElementById('id_vis_curso'), this, 'curso')">
       <OPTION value="qp" <?php if ("qp" == $curso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $curso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $curso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $curso_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_curso" <?php echo $str_hide_curso?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<?php
      $curso_look = substr($this->Db->qstr($curso), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct curso from " . $this->Ini->nm_tabela . " where curso = '$curso_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      if (isset($nmgp_def_dados[0][$curso]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$curso];
      }
      else
      {
          $sAutocompValue = $curso;
      }
?>
<INPUT  type="text" id="SC_curso" name="curso" value="<?php echo NM_encode_input($curso) ?>" size=50 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_curso" name="curso_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_turno_cond" name="turno_cond" onChange="nm_campos_between(document.getElementById('id_vis_turno'), this, 'turno')">
       <OPTION value="qp" <?php if ("qp" == $turno_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $turno_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $turno_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $turno_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_turno" <?php echo $str_hide_turno?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<?php
      $turno_look = substr($this->Db->qstr($turno), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct turno from " . $this->Ini->nm_tabela . " where turno = '$turno_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
      ...
      {
          $sAutocompValue = $turno;
      }
?>
<INPUT  type="text" id="SC_turno" name="turno" value="<?php echo NM_encode_input($turno) ?>" size=5 alt="{datatype: 'text', maxLength: 5, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_turno" name="turno_autocomp" size="5" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 5, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_id_aluno'), document.F1.id_aluno_cond, 'id_aluno');
   document.F1.id_aluno.value = "";
   document.F1.id_aluno_autocomp.value = "";
   document.F1.id_aluno_input_2.value = "";
   nm_campos_between(document.getElementById('id_vis_nome_aluno'), document.F1.nome_aluno_cond, 'nome_aluno');
   document.F1.nome_aluno.value = "";
   document.F1.nome_aluno_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_curso'), document.F1.curso_cond, 'curso');
   document.F1.curso.value = "";
   document.F1.curso_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_turno'), document.F1.turno_cond, 'turno');
   document.F1.turno.value = "";
   document.F1.turno_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['where_orig']))
      {
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_id_aluno_cond'] = 'cond';
      $tp_fields['SC_id_aluno'] = 'text_aut';
      $tp_fields['id_ac_id_aluno'] = 'text_aut';
      $tp_fields['SC_id_aluno_input_2'] = 'text';
      $tp_fields['SC_nome_aluno_cond'] = 'cond';
      $tp_fields['SC_nome_aluno'] = 'text_aut';
      $tp_fields['id_ac_nome_aluno'] = 'text_aut';
      $tp_fields['SC_curso_cond'] = 'cond';
      $tp_fields['SC_curso'] = 'text_aut';
      $tp_fields['id_ac_curso'] = 'text_aut';
      $tp_fields['SC_turno_cond'] = 'cond';
      $tp_fields['SC_turno'] = 'text_aut';
      $tp_fields['id_ac_turno'] = 'text_aut';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $id_aluno_cond, $id_aluno, $id_aluno_input_2, $id_aluno_autocomp,
             $nome_aluno_cond, $nome_aluno, $nome_aluno_autocomp,
             $curso_cond, $curso, $curso_autocomp,
             $turno_cond, $turno, $turno_autocomp, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($id_aluno_autocomp) && empty($id_aluno))
      {
          $id_aluno = $id_aluno_autocomp;
      }
      if (!empty($nome_aluno_autocomp) && empty($nome_aluno))
      {
          $nome_aluno = $nome_aluno_autocomp;
      }
      if (!empty($curso_autocomp) && empty($curso))
      {
          $curso = $curso_autocomp;
      }
      if (!empty($turno_autocomp) && empty($turno))
      {
          $turno = $turno_autocomp;
      }
      $id_aluno_cond_salva = $id_aluno_cond; 
      if (!isset($id_aluno_input_2) || $id_aluno_input_2 == "")
      {
          $id_aluno_input_2 = $id_aluno;
      }
      $nome_aluno_cond_salva = $nome_aluno_cond; 
      if (!isset($nome_aluno_input_2) || $nome_aluno_input_2 == "")
      {
          $nome_aluno_input_2 = $nome_aluno;
      }
      $curso_cond_salva = $curso_cond; 
      if (!isset($curso_input_2) || $curso_input_2 == "")
      {
          $curso_input_2 = $curso;
      }
      ...
      if ($id_aluno_cond != "in")
      {
          nm_limpa_numero($id_aluno, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $id_aluno);
          ...
          $id_aluno = implode(",", $Nm_sc_valores);
      }
      if ($id_aluno_cond != "in")
      {
          nm_limpa_numero($id_aluno_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']['id_aluno'] = $id_aluno; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']['id_aluno_input_2'] = $id_aluno_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']['id_aluno_cond'] = $id_aluno_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']['nome_aluno'] = $nome_aluno; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']['nome_aluno_cond'] = $nome_aluno_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']['curso'] = $curso; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']['curso_cond'] = $curso_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']['turno'] = $turno; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']['turno_cond'] = $turno_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($id_aluno_cond != "in" && $id_aluno_cond != "bw" && !empty($id_aluno) && !is_numeric($id_aluno))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Aluno";
      }
      if ($id_aluno_cond == "bw" && ((!empty($id_aluno) && !is_numeric($id_aluno)) || (!empty($id_aluno_input_2) && !is_numeric($id_aluno_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Id Aluno";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_aluno'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['id_aluno'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['id_aluno'] = $id_aluno;
      }
      $Conteudo = $id_aluno_input_2;
      if (strtoupper($id_aluno_cond) != "II" && strtoupper($id_aluno_cond) != "QP" && strtoupper($id_aluno_cond) != "NP" && strtoupper($id_aluno_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_aluno_input_2'] = $Conteudo;
      $nome_aluno_look = substr($this->Db->qstr($nome_aluno), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nome_aluno from " . $this->Ini->nm_tabela . " where nome_aluno = '$nome_aluno_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nome_aluno'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['nome_aluno'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nome_aluno'] = $nome_aluno;
      }
      $curso_look = substr($this->Db->qstr($curso), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct curso from " . $this->Ini->nm_tabela . " where curso = '$curso_look'"; 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['curso'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['curso'] = $curso;
      }
      $turno_look = substr($this->Db->qstr($turno), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct turno from " . $this->Ini->nm_tabela . " where turno = '$turno_look'"; 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['turno'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['turno'] = $turno;
      }

      //----- $id_aluno
      $this->Date_part = false;
      if (isset($id_aluno) || $id_aluno_cond == "nu" || $id_aluno_cond == "nn" || $id_aluno_cond == "ep" || $id_aluno_cond == "ne")
      {
         $this->monta_condicao("id_aluno", $id_aluno_cond, $id_aluno, $id_aluno_input_2, "id_aluno");
      }

      //----- $nome_aluno
      $this->Date_part = false;
      if (isset($nome_aluno) || $nome_aluno_cond == "nu" || $nome_aluno_cond == "nn" || $nome_aluno_cond == "ep" || $nome_aluno_cond == "ne")
      {
         $this->monta_condicao("nome_aluno", $nome_aluno_cond, $nome_aluno, "", "nome_aluno");
      }

      //----- $curso
      $this->Date_part = false;
      if (isset($curso) || $curso_cond == "nu" || $curso_cond == "nn" || $curso_cond == "ep" || $curso_cond == "ne")
      {
         $this->monta_condicao("curso", $curso_cond, $curso, "", "curso");
      }

      //----- $turno
      $this->Date_part = false;
      if (isset($turno) || $turno_cond == "nu" || $turno_cond == "nn" || $turno_cond == "ep" || $turno_cond == "ne")
      {
