...
function Sel_cmp_init()
{
   ...
   $tab_ger_campos['id_aluno'] = "on";
   $tab_ger_campos['nome_aluno'] = "on";
   $tab_ger_campos['curso'] = "on";
   $tab_ger_campos['turno'] = "on";
   $tab_ger_campos['matricula'] = "on";
   $tab_ger_campos['cpf'] = "on";
...
<?php
   ...
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if ($NM_cada_opc != "on")
           {
               $prep_combo[strtolower($NM_cada_field)] = $_SESSION['sc_session'][$this->sc_init]['grid_aluno']['labels'][$NM_cada_field];
           }
       }
   }
...
<?php
   if (isset($_SESSION['sc_session'][$this->sc_init]['grid_aluno']['field_order']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['grid_aluno']['field_order'] as $NM_cada_field)
       {
           if ($tab_ger_campos[$NM_cada_field] == "on")
           {
               ...
               {
?>
     <li class="sc_ui_litem scAppDivSelectFieldsEnabled" id="sc_id_itemsel_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $_SESSION['sc_session'][$this->sc_init]['grid_aluno']['labels'][$NM_cada_field]; ?></li>
<?php
               }
               else
               {
?>
     <li class="sc_ui_litem scAppDivSelectFieldsDisabled" id="sc_id_itemsel_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $_SESSION['sc_session'][$this->sc_init]['grid_aluno']['labels'][$NM_cada_field]; ?></li>
<?php
               }
           }
       }
