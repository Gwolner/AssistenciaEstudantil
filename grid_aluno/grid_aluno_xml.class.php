...
class grid_aluno_xml
{
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['xml_name']);
      }
      if (!$this->Grava_view)
      {
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->nome_aluno))
         {
             $this->nome_aluno = sc_convert_encoding($this->nome_aluno, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " nome_aluno =\"" . $this->trata_dados($this->nome_aluno) . "\"";
   }
   //----- curso
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_aluno']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - aluno :: XML</TITLE>
