...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_aluno";$Nm_numeric[] = "id_aluno";
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_id_aluno"  <?php echo $str_hide_id_aluno?>><?php
      $id_aluno_look = substr($this->Db->qstr($id_aluno), 1, -1); 
      $nmgp_def_dados = array(); 
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id_aluno" name="id_aluno_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
         <BR>
        <SPAN id="id_vis_id_aluno"  <?php echo $str_display_id_aluno; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_id_aluno_input_2" name="id_aluno_input_2" value="<?php echo NM_encode_input($id_aluno_input_2) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_nome_aluno"  <?php echo $str_hide_nome_aluno?>><?php
      $nome_aluno_look = substr($this->Db->qstr($nome_aluno), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_curso"  <?php echo $str_hide_curso?>><?php
      $curso_look = substr($this->Db->qstr($curso), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php echo $SC_Label ?><br>
      ...
      <br><span id="id_hide_turno"  <?php echo $str_hide_turno?>><?php
      $turno_look = substr($this->Db->qstr($turno), 1, -1); 
      $nmgp_def_dados = array(); 
