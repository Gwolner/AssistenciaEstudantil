<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_aluno_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_aluno_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_def_campos['id_aluno'] = "id_aluno";
   $tab_converte["id_aluno"]   = "id_aluno";
   $tab_labels["id_aluno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aluno']['labels']["id_aluno"])) ? $_SESSION['sc_session'][$sc_init]['grid_aluno']['labels']["id_aluno"] : "Id Aluno";
   $tab_ger_campos['nome_aluno'] = "on";
   $tab_def_campos['nome_aluno'] = "nome_aluno";
   $tab_converte["nome_aluno"]   = "nome_aluno";
   $tab_labels["nome_aluno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aluno']['labels']["nome_aluno"])) ? $_SESSION['sc_session'][$sc_init]['grid_aluno']['labels']["nome_aluno"] : "Nome Aluno";
   $tab_ger_campos['curso'] = "on";
   $tab_def_campos['curso'] = "curso";
   $tab_converte["curso"]   = "curso";
   $tab_labels["curso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aluno']['labels']["curso"])) ? $_SESSION['sc_session'][$sc_init]['grid_aluno']['labels']["curso"] : "Curso";
   $tab_ger_campos['turno'] = "on";
   $tab_def_campos['turno'] = "turno";
   $tab_converte["turno"]   = "turno";
   $tab_labels["turno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aluno']['labels']["turno"])) ? $_SESSION['sc_session'][$sc_init]['grid_aluno']['labels']["turno"] : "Turno";
   $tab_ger_campos['matricula'] = "on";
   $tab_def_campos['matricula'] = "matricula";
   $tab_converte["matricula"]   = "matricula";
   $tab_labels["matricula"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aluno']['labels']["matricula"])) ? $_SESSION['sc_session'][$sc_init]['grid_aluno']['labels']["matricula"] : "Matricula";
   $tab_ger_campos['cpf'] = "on";
   $tab_def_campos['cpf'] = "cpf";
   $tab_converte["cpf"]   = "cpf";
   $tab_labels["cpf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_aluno']['labels']["cpf"])) ? $_SESSION['sc_session'][$sc_init]['grid_aluno']['labels']["cpf"] : "Cpf";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_aluno']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_aluno']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_aluno']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_aluno']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_aluno']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_aluno']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_aluno']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_aluno']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_aluno']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_aluno_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_aluno']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_aluno']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
