...
<?php
include_once("form_fardamento_tradicional_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_fardamento_tradicional_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['recarga'];
}
?>
...
<?php
 include_once("form_fardamento_tradicional_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" 
               action="form_fardamento_tradicional_mob.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_fardamento_tradicional_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_fardamento_tradicional_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_tamanho_line" id="hidden_field_data_id_tamanho" style="<?php echo $sStyleHidden_id_tamanho; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_tamanho_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_tamanho_label"><span id="id_label_id_tamanho"><?php echo $this->nm_new_label['id_tamanho']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['php_cmp_required']['id_tamanho']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['php_cmp_required']['id_tamanho'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_data_entregue_line" id="hidden_field_data_data_entregue" style="<?php echo $sStyleHidden_data_entregue; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_data_entregue_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_data_entregue_label"><span id="id_label_data_entregue"><?php echo $this->nm_new_label['data_entregue']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['php_cmp_required']['data_entregue']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['php_cmp_required']['data_entregue'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['total'] + 1)?>);</script><?php }} ?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_tradicional_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_fardamento_tradicional_mob");
 parent.scAjaxDetailHeight("form_fardamento_tradicional_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
