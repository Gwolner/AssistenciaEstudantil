...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno2']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_aluno2"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_Voltar_global_consulta = "<?php echo $this->form_encode_input($this->nmgp_dados_form['id_aluno']); ?>";
function sc_btn_Voltar()
{
  ...
  nm_gp_submit('<?php echo $this->Ini->link_control_aluno_edit; ?>', '<?php echo $this->Ini->path_link . "" . SC_dir_app_name('control_aluno') . "/"; ?>', '<?php echo "global_consulta?#?' + var_btn_Voltar_global_consulta + '?@?NM_btn_insert?#?N?@?NM_btn_update?#?N?@?NM_btn_delete?#?N?@?NM_btn_navega?#?N?@?"; ?>', '', '_self', '0', '0', 'control_aluno');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno2']['where_detal']))
  {
?>  
