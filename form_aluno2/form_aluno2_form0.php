...
<?php
include_once("form_aluno2_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_aluno2_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno2']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno2']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno2']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno2']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno2']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno2']['recarga'];
}
?>
...
<?php
 include_once("form_aluno2_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno2']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno2']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_aluno2'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_aluno2'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno2']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno2']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_aluno_label" id="hidden_field_label_id_aluno" style="<?php echo $sStyleHidden_id_aluno; ?>"><span id="id_label_id_aluno"><?php echo $this->nm_new_label['id_aluno']; ?></span></TD>
    <TD class="scFormDataOdd css_id_aluno_line" id="hidden_field_data_id_aluno" style="<?php echo $sStyleHidden_id_aluno; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_aluno_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_id_aluno" class="css_id_aluno_line" style="<?php echo $sStyleReadLab_id_aluno; ?>"><?php echo $this->form_encode_input($this->id_aluno); ?></span><span id="id_read_off_id_aluno" style="<?php echo $sStyleReadInp_id_aluno; ?>"><input type="hidden" name="id_aluno" value="<?php echo $this->form_encode_input($id_aluno) . "\">"?><span id="id_ajax_label_id_aluno"><?php echo nl2br($id_aluno); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_data_entrega_label" id="hidden_field_label_data_entrega" style="<?php echo $sStyleHidden_data_entrega; ?>"><span id="id_label_data_entrega"><?php echo $this->nm_new_label['data_entrega']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno2']['php_cmp_required']['data_entrega']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno2']['php_cmp_required']['data_entrega'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_data_devolucao_label" id="hidden_field_label_data_devolucao" style="<?php echo $sStyleHidden_data_devolucao; ?>"><span id="id_label_data_devolucao"><?php echo $this->nm_new_label['data_devolucao']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno2']['php_cmp_required']['data_devolucao']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno2']['php_cmp_required']['data_devolucao'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_aluno2_empty.htm' : $this->Ini->link_form_emprestimo_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y');
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno2']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno2']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno2']['run_iframe'] != "R")
{
?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bincluir", "nm_atualiza ('incluir');", "nm_atualiza ('incluir');", "sc_b_ins_b", "", "Realizar Empréstimo", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_aluno2']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_aluno2");
 parent.scAjaxDetailHeight("form_aluno2", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
