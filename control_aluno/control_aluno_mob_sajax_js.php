  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_aluno_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_control_aluno_mob_validate_forma_de_consulta()
  {
    ...
    x_ajax_control_aluno_mob_validate_forma_de_consulta(var_forma_de_consulta, var_script_case_init, do_ajax_control_aluno_mob_validate_forma_de_consulta_cb);
  } // do_ajax_control_aluno_mob_validate_forma_de_consulta

  function do_ajax_control_aluno_mob_validate_forma_de_consulta_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_aluno_mob_validate_forma_de_consulta_cb

  // ---------- Validate matricula
  function do_ajax_control_aluno_mob_validate_matricula()
  {
    var nomeCampo_matricula = "matricula";
    var var_matricula = scAjaxGetFieldText(nomeCampo_matricula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_aluno_mob_validate_matricula(var_matricula, var_script_case_init, do_ajax_control_aluno_mob_validate_matricula_cb);
  } // do_ajax_control_aluno_mob_validate_matricula

  function do_ajax_control_aluno_mob_validate_matricula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_aluno_mob_validate_matricula_cb

  // ---------- Validate cpf
  function do_ajax_control_aluno_mob_validate_cpf()
  {
    var nomeCampo_cpf = "cpf";
    var var_cpf = scAjaxGetFieldText(nomeCampo_cpf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_aluno_mob_validate_cpf(var_cpf, var_script_case_init, do_ajax_control_aluno_mob_validate_cpf_cb);
  } // do_ajax_control_aluno_mob_validate_cpf

  function do_ajax_control_aluno_mob_validate_cpf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cpf";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_aluno_mob_validate_cpf_cb

  // ---------- Event onclick forma_de_consulta
  function do_ajax_control_aluno_mob_event_forma_de_consulta_onclick()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_control_aluno_mob_event_forma_de_consulta_onclick(var_forma_de_consulta, var_cpf, var_matricula, var_script_case_init, do_ajax_control_aluno_mob_event_forma_de_consulta_onclick_cb);
  } // do_ajax_control_aluno_mob_event_forma_de_consulta_onclick

  function do_ajax_control_aluno_mob_event_forma_de_consulta_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "forma_de_consulta";
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_aluno_mob_event_forma_de_consulta_onclick_cb
  // ---------- Form
  function do_ajax_control_aluno_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_aluno_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_forma_de_consulta = scAjaxGetFieldRadio("forma_de_consulta");
    ...
    scAjaxProcOn();
    x_ajax_control_aluno_mob_submit_form(var_forma_de_consulta, var_matricula, var_cpf, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_aluno_mob_submit_form_cb);
  } // do_ajax_control_aluno_mob_submit_form

  function do_ajax_control_aluno_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_aluno_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_aluno_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_aluno_mob_navigate_form

  function do_ajax_control_aluno_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_control_aluno_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_aluno_mob_navigate_form_cb
  function sc_hide_control_aluno_mob_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_aluno_mob_form
