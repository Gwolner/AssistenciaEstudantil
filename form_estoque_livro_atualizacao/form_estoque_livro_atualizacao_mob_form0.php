...
<?php
include_once("form_estoque_livro_atualizacao_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_estoque_livro_atualizacao_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['recarga'];
}
?>
...
<?php
 include_once("form_estoque_livro_atualizacao_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" 
               action="form_estoque_livro_atualizacao_mob.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['insert_validation']; ?>">
<?php
}
?>
...
<input type="hidden" name="id_estoque_livro" value="<?php  echo $this->form_encode_input($this->id_estoque_livro) ?>">
<input type="hidden" name="_sc_force_mobile" id="sc-id-mobile-control" value="" />
<?php
$_SESSION['scriptcase']['error_span_title']['form_estoque_livro_atualizacao_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_estoque_livro_atualizacao_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tipo_livro_line" id="hidden_field_data_tipo_livro" style="<?php echo $sStyleHidden_tipo_livro; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_livro_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tipo_livro_label"><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['php_cmp_required']['tipo_livro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['php_cmp_required']['tipo_livro'] == "on") { ?><span class="scFormRequiredOdd">*</span> <?php }?> <span id="id_label_tipo_livro"><?php echo $this->nm_new_label['tipo_livro']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['Lookup_tipo_livro'][] = 'didatico'; ?>
<?php  if ("didatico" == $this->tipo_livro)  { echo " checked" ;} ?><?php  if (empty($this->tipo_livro)) { echo " checked" ;} ?>  onClick="do_ajax_form_estoque_livro_atualizacao_mob_event_tipo_livro_onclick();" >Didático</TD>
</TR>
<TR>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['Lookup_tipo_livro'][] = 'paradidatico'; ?>
<?php  if ("paradidatico" == $this->tipo_livro)  { echo " checked" ;} ?>  onClick="do_ajax_form_estoque_livro_atualizacao_mob_event_tipo_livro_onclick();" >Paradidático</TD>
</TR></TABLE>
</div>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_materia_line" id="hidden_field_data_materia" style="<?php echo $sStyleHidden_materia; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_materia_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_materia_label"><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['php_cmp_required']['materia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['php_cmp_required']['materia'] == "on") { ?><span class="scFormRequiredOdd">*</span> <?php }?> <span id="id_label_materia"><?php echo $this->nm_new_label['materia']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_titulo_line" id="hidden_field_data_titulo" style="<?php echo $sStyleHidden_titulo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_titulo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_titulo_label"><span id="id_label_titulo"><?php echo $this->nm_new_label['titulo']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_autor_line" id="hidden_field_data_autor" style="<?php echo $sStyleHidden_autor; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_autor_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_autor_label"><span id="id_label_autor"><?php echo $this->nm_new_label['autor']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_isbn_line" id="hidden_field_data_isbn" style="<?php echo $sStyleHidden_isbn; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_isbn_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_isbn_label"><span id="id_label_isbn"><?php echo $this->nm_new_label['isbn']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_quantidade_entrada_line" id="hidden_field_data_quantidade_entrada" style="<?php echo $sStyleHidden_quantidade_entrada; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_quantidade_entrada_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_quantidade_entrada_label"><span id="id_label_quantidade_entrada"><?php echo $this->nm_new_label['quantidade_entrada']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_quantidade_line" id="hidden_field_data_quantidade" style="<?php echo $sStyleHidden_quantidade; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_quantidade_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_quantidade_label"><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['php_cmp_required']['quantidade']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['php_cmp_required']['quantidade'] == "on") { ?><span class="scFormRequiredOdd">*</span> <?php }?> <span id="id_label_quantidade"><?php echo $this->nm_new_label['quantidade']; ?></span></span><br><input type="hidden" name="quantidade" value="<?php echo $this->form_encode_input($quantidade); ?>"><span id="id_ajax_label_quantidade"><?php echo nl2br($quantidade); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_volume_line" id="hidden_field_data_id_volume" style="<?php echo $sStyleHidden_id_volume; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_volume_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_volume_label"><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['php_cmp_required']['id_volume']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['php_cmp_required']['id_volume'] == "on") { ?><span class="scFormRequiredOdd">*</span> <?php }?> <span id="id_label_id_volume"><?php echo $this->nm_new_label['id_volume']; ?></span></span><br>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_atualizacao_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_estoque_livro_atualizacao_mob");
 parent.scAjaxDetailHeight("form_estoque_livro_atualizacao_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
