...
<?php
include_once("form_fardamento_educacao_fisica_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_fardamento_educacao_fisica_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['recarga'];
}
?>
...
<?php
 include_once("form_fardamento_educacao_fisica_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_fardamento_educacao_fisica'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_fardamento_educacao_fisica'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['run_iframe'] != "R")
{
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tamanho_pedido_label" id="hidden_field_label_tamanho_pedido" style="<?php echo $sStyleHidden_tamanho_pedido; ?>"><span id="id_label_tamanho_pedido"><?php echo $this->nm_new_label['tamanho_pedido']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['php_cmp_required']['tamanho_pedido']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['php_cmp_required']['tamanho_pedido'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_tamanho_label" id="hidden_field_label_id_tamanho" style="<?php echo $sStyleHidden_id_tamanho; ?>"><span id="id_label_id_tamanho"><?php echo $this->nm_new_label['id_tamanho']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['php_cmp_required']['id_tamanho']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['php_cmp_required']['id_tamanho'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_quantidade_label" id="hidden_field_label_quantidade" style="<?php echo $sStyleHidden_quantidade; ?>"><span id="id_label_quantidade"><?php echo $this->nm_new_label['quantidade']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['php_cmp_required']['quantidade']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['php_cmp_required']['quantidade'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_data_entregue_label" id="hidden_field_label_data_entregue" style="<?php echo $sStyleHidden_data_entregue; ?>"><span id="id_label_data_entregue"><?php echo $this->nm_new_label['data_entregue']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['php_cmp_required']['data_entregue']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['php_cmp_required']['data_entregue'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_fardamento_educacao_fisica");
 parent.scAjaxDetailHeight("form_fardamento_educacao_fisica", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
