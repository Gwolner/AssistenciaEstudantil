...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_fardamento_educacao_fisica/form_fardamento_educacao_fisica_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_fardamento_educacao_fisica_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_fardamento_educacao_fisica_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['recarga'];
}
?>
...
<?php
 include_once("form_fardamento_educacao_fisica_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" 
               action="form_fardamento_educacao_fisica_mob.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_fardamento_educacao_fisica_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_fardamento_educacao_fisica_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['fast_search'][2] : "";
?> 
...
<?php echo nmButtonOutput($this->arr_buttons, "bincluir", "nm_atualiza ('incluir');", "nm_atualiza ('incluir');", "sc_b_ins_t", "", "Entregar", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "group_2_t");?>
  </div>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_id_fardamento_line" id="hidden_field_data_id_fardamento" style="<?php echo $sStyleHidden_id_fardamento; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_fardamento_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_fardamento_label"><span id="id_label_id_fardamento"><?php echo $this->nm_new_label['id_fardamento']; ?></span></span><br><span id="id_read_on_id_fardamento" class="css_id_fardamento_line" style="<?php echo $sStyleReadLab_id_fardamento; ?>"><?php echo $this->form_encode_input($this->id_fardamento); ?></span><span id="id_read_off_id_fardamento" style="<?php echo $sStyleReadInp_id_fardamento; ?>"><input type="hidden" name="id_fardamento" value="<?php echo $this->form_encode_input($id_fardamento) . "\">"?><span id="id_ajax_label_id_fardamento"><?php echo nl2br($id_fardamento); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_aviso_line" id="hidden_field_data_aviso" style="<?php echo $sStyleHidden_aviso; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_aviso_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_aviso_label"><span id="id_label_aviso"><?php echo $this->nm_new_label['aviso']; ?></span></span><br><input type="hidden" name="aviso" value="<?php echo $this->form_encode_input($aviso); ?>"><span id="id_ajax_label_aviso"><?php echo nl2br($aviso); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tamanho_pedido_line" id="hidden_field_data_tamanho_pedido" style="<?php echo $sStyleHidden_tamanho_pedido; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tamanho_pedido_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tamanho_pedido_label"><span id="id_label_tamanho_pedido"><?php echo $this->nm_new_label['tamanho_pedido']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['php_cmp_required']['tamanho_pedido']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['php_cmp_required']['tamanho_pedido'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_tamanho_line" id="hidden_field_data_id_tamanho" style="<?php echo $sStyleHidden_id_tamanho; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_tamanho_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_tamanho_label"><span id="id_label_id_tamanho"><?php echo $this->nm_new_label['id_tamanho']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['php_cmp_required']['id_tamanho']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['php_cmp_required']['id_tamanho'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_quantidade_line" id="hidden_field_data_quantidade" style="<?php echo $sStyleHidden_quantidade; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_quantidade_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_quantidade_label"><span id="id_label_quantidade"><?php echo $this->nm_new_label['quantidade']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['php_cmp_required']['quantidade']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['php_cmp_required']['quantidade'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_data_entregue_line" id="hidden_field_data_data_entregue" style="<?php echo $sStyleHidden_data_entregue; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_data_entregue_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_data_entregue_label"><span id="id_label_data_entregue"><?php echo $this->nm_new_label['data_entregue']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['php_cmp_required']['data_entregue']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['php_cmp_required']['data_entregue'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_situacao_line" id="hidden_field_data_id_situacao" style="<?php echo $sStyleHidden_id_situacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_situacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_situacao_label"><span id="id_label_id_situacao"><?php echo $this->nm_new_label['id_situacao']; ?></span></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['total'] + 1)?>);</script><?php }} ?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_fardamento_educacao_fisica_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_fardamento_educacao_fisica_mob");
 parent.scAjaxDetailHeight("form_fardamento_educacao_fisica_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
