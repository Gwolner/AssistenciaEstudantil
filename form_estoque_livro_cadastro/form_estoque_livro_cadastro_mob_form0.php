...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_estoque_livro_cadastro/form_estoque_livro_cadastro_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_estoque_livro_cadastro_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_estoque_livro_cadastro_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['recarga'];
}
?>
...
<?php
 include_once("form_estoque_livro_cadastro_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form name="F1" method="post" 
               action="form_estoque_livro_cadastro_mob.php" 
               target="_self"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_estoque_livro_cadastro_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_estoque_livro_cadastro_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['fast_search'][2] : "";
?> 
...
<?php 
        ...
        $sCondStyle = ($this->nmgp_botoes['new'] != 'off' || $this->nmgp_botoes['insert'] != 'off' || $this->nmgp_botoes['exit'] != 'off') ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tipo_livro_line" id="hidden_field_data_tipo_livro" style="<?php echo $sStyleHidden_tipo_livro; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_livro_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tipo_livro_label"><span id="id_label_tipo_livro"><?php echo $this->nm_new_label['tipo_livro']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['php_cmp_required']['tipo_livro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['php_cmp_required']['tipo_livro'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['Lookup_tipo_livro'][] = 'didatico'; ?>
<?php  if ("didatico" == $this->tipo_livro)  { echo " checked" ;} ?><?php  if (empty($this->tipo_livro)) { echo " checked" ;} ?>  onClick="do_ajax_form_estoque_livro_cadastro_mob_event_tipo_livro_onclick();" >Didático</TD>
</TR>
<TR>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['Lookup_tipo_livro'][] = 'paradidatico'; ?>
<?php  if ("paradidatico" == $this->tipo_livro)  { echo " checked" ;} ?>  onClick="do_ajax_form_estoque_livro_cadastro_mob_event_tipo_livro_onclick();" >Paradidático</TD>
</TR></TABLE>
</div>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_materia_line" id="hidden_field_data_materia" style="<?php echo $sStyleHidden_materia; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_materia_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_materia_label"><span id="id_label_materia"><?php echo $this->nm_new_label['materia']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['php_cmp_required']['materia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['php_cmp_required']['materia'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_volume_line" id="hidden_field_data_id_volume" style="<?php echo $sStyleHidden_id_volume; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_volume_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_volume_label"><span id="id_label_id_volume"><?php echo $this->nm_new_label['id_volume']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['php_cmp_required']['id_volume']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['php_cmp_required']['id_volume'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['mostra_cab'] != "N"))
  {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro_mob']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_estoque_livro_cadastro_mob");
 parent.scAjaxDetailHeight("form_estoque_livro_cadastro_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
