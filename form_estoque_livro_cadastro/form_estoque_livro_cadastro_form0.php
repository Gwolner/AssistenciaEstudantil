...
<?php
include_once("form_estoque_livro_cadastro_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_estoque_livro_cadastro_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['recarga'];
}
?>
...
<?php
 include_once("form_estoque_livro_cadastro_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_estoque_livro_cadastro'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_estoque_livro_cadastro'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipo_livro_label" id="hidden_field_label_tipo_livro" style="<?php echo $sStyleHidden_tipo_livro; ?>"><span id="id_label_tipo_livro"><?php echo $this->nm_new_label['tipo_livro']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['php_cmp_required']['tipo_livro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['php_cmp_required']['tipo_livro'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['Lookup_tipo_livro'][] = 'didatico'; ?>
<?php  if ("didatico" == $this->tipo_livro)  { echo " checked" ;} ?><?php  if (empty($this->tipo_livro)) { echo " checked" ;} ?>  onClick="do_ajax_form_estoque_livro_cadastro_event_tipo_livro_onclick();" >Didático</TD>
</TR>
<TR>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['Lookup_tipo_livro'][] = 'paradidatico'; ?>
<?php  if ("paradidatico" == $this->tipo_livro)  { echo " checked" ;} ?>  onClick="do_ajax_form_estoque_livro_cadastro_event_tipo_livro_onclick();" >Paradidático</TD>
</TR></TABLE>
</div>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_materia_label" id="hidden_field_label_materia" style="<?php echo $sStyleHidden_materia; ?>"><span id="id_label_materia"><?php echo $this->nm_new_label['materia']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['php_cmp_required']['materia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['php_cmp_required']['materia'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_quantidade_label" id="hidden_field_label_quantidade" style="<?php echo $sStyleHidden_quantidade; ?>"><span id="id_label_quantidade"><?php echo $this->nm_new_label['quantidade']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['php_cmp_required']['quantidade']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['php_cmp_required']['quantidade'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_volume_label" id="hidden_field_label_id_volume" style="<?php echo $sStyleHidden_id_volume; ?>"><span id="id_label_id_volume"><?php echo $this->nm_new_label['id_volume']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['php_cmp_required']['id_volume']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['php_cmp_required']['id_volume'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['mostra_cab'] != "N"))
  {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estoque_livro_cadastro']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_estoque_livro_cadastro");
 parent.scAjaxDetailHeight("form_estoque_livro_cadastro", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
